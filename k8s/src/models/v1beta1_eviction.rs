...
pub struct V1beta1Eviction {
  ...
  delete_options: Option<::models::V1DeleteOptions>,
...
impl V1beta1Eviction {
  ...
  pub fn with_api_version(mut self, api_version: String) -> V1beta1Eviction {
    self.api_version = Some(api_version);
    self
  }
  ...
  pub fn set_delete_options(&mut self, delete_options: ::models::V1DeleteOptions) {
    self.delete_options = Some(delete_options);
  }

  pub fn with_delete_options(mut self, delete_options: ::models::V1DeleteOptions) -> V1beta1Eviction {
    self.delete_options = Some(delete_options);
    self
  }

  pub fn delete_options(&self) -> Option<&::models::V1DeleteOptions> {
  ...
  pub fn with_kind(mut self, kind: String) -> V1beta1Eviction {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> V1beta1Eviction {
    self.metadata = Some(metadata);
    self
  }
