...
impl V1IscsiPersistentVolumeSource {
  ...
  pub fn with_chap_auth_discovery(mut self, chap_auth_discovery: bool) -> V1IscsiPersistentVolumeSource {
    self.chap_auth_discovery = Some(chap_auth_discovery);
    self
  }
  ...
  pub fn with_chap_auth_session(mut self, chap_auth_session: bool) -> V1IscsiPersistentVolumeSource {
    self.chap_auth_session = Some(chap_auth_session);
    self
  }
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> V1IscsiPersistentVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_initiator_name(mut self, initiator_name: String) -> V1IscsiPersistentVolumeSource {
    self.initiator_name = Some(initiator_name);
    self
  }
  ...
  pub fn with_iqn(mut self, iqn: String) -> V1IscsiPersistentVolumeSource {
    self.iqn = iqn;
    self
  }
  ...
  pub fn with_iscsi_interface(mut self, iscsi_interface: String) -> V1IscsiPersistentVolumeSource {
    self.iscsi_interface = Some(iscsi_interface);
    self
  }
  ...
  pub fn with_lun(mut self, lun: i32) -> V1IscsiPersistentVolumeSource {
    self.lun = lun;
    self
  }
  ...
  pub fn with_portals(mut self, portals: Vec<String>) -> V1IscsiPersistentVolumeSource {
    self.portals = Some(portals);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> V1IscsiPersistentVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::V1SecretReference) -> V1IscsiPersistentVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }
  ...
  pub fn with_target_portal(mut self, target_portal: String) -> V1IscsiPersistentVolumeSource {
    self.target_portal = target_portal;
    self
  }
