...
impl V1beta1IpBlock {
  ...
  pub fn new(cidr: String) -> V1beta1IpBlock {
    V1beta1IpBlock {
      cidr: cidr,
      except: None
    }
  ...
  pub fn with_cidr(mut self, cidr: String) -> V1beta1IpBlock {
    self.cidr = cidr;
    self
  }
  ...
  pub fn with_except(mut self, except: Vec<String>) -> V1beta1IpBlock {
    self.except = Some(except);
    self
  }
