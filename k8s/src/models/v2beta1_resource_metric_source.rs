...
impl V2beta1ResourceMetricSource {
  ...
  pub fn with_name(mut self, name: String) -> V2beta1ResourceMetricSource {
    self.name = name;
    self
  }
  ...
  pub fn with_target_average_utilization(mut self, target_average_utilization: i32) -> V2beta1ResourceMetricSource {
    self.target_average_utilization = Some(target_average_utilization);
    self
  }
  ...
  pub fn with_target_average_value(mut self, target_average_value: String) -> V2beta1ResourceMetricSource {
    self.target_average_value = Some(target_average_value);
    self
  }
