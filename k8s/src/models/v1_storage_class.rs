...
impl V1StorageClass {
  ...
  pub fn with_allow_volume_expansion(mut self, allow_volume_expansion: bool) -> V1StorageClass {
    self.allow_volume_expansion = Some(allow_volume_expansion);
    self
  }
  ...
  pub fn with_allowed_topologies(mut self, allowed_topologies: Vec<::models::V1TopologySelectorTerm>) -> V1StorageClass {
    self.allowed_topologies = Some(allowed_topologies);
    self
  }
  ...
  pub fn with_api_version(mut self, api_version: String) -> V1StorageClass {
    self.api_version = Some(api_version);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1StorageClass {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> V1StorageClass {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_mount_options(mut self, mount_options: Vec<String>) -> V1StorageClass {
    self.mount_options = Some(mount_options);
    self
  }
  ...
  pub fn with_parameters(mut self, parameters: ::std::collections::HashMap<String, String>) -> V1StorageClass {
    self.parameters = Some(parameters);
    self
  }
  ...
  pub fn with_provisioner(mut self, provisioner: String) -> V1StorageClass {
    self.provisioner = provisioner;
    self
  }
  ...
  pub fn with_reclaim_policy(mut self, reclaim_policy: String) -> V1StorageClass {
    self.reclaim_policy = Some(reclaim_policy);
    self
  }
  ...
  pub fn with_volume_binding_mode(mut self, volume_binding_mode: String) -> V1StorageClass {
    self.volume_binding_mode = Some(volume_binding_mode);
    self
  }
