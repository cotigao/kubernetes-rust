...
pub struct V1PodSecurityContext {
  ...
  sysctls: Option<Vec<::models::V1Sysctl>>
}
...
impl V1PodSecurityContext {
  ...
  pub fn with_run_as_group(mut self, run_as_group: i64) -> V1PodSecurityContext {
    self.run_as_group = Some(run_as_group);
    self
  }
  ...
  pub fn set_sysctls(&mut self, sysctls: Vec<::models::V1Sysctl>) {
    self.sysctls = Some(sysctls);
  }

  pub fn with_sysctls(mut self, sysctls: Vec<::models::V1Sysctl>) -> V1PodSecurityContext {
    self.sysctls = Some(sysctls);
    self
  }

  pub fn sysctls(&self) -> Option<&Vec<::models::V1Sysctl>> {
    self.sysctls.as_ref()
  }
