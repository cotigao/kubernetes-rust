...
pub struct V1Endpoints {
  ...
  subsets: Option<Vec<::models::V1EndpointSubset>>
}
...
impl V1Endpoints {
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> V1Endpoints {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn subsets(&self) -> Option<&Vec<::models::V1EndpointSubset>> {
    self.subsets.as_ref()
  }
