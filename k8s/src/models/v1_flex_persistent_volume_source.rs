...
impl V1FlexPersistentVolumeSource {
  ...
  pub fn with_driver(mut self, driver: String) -> V1FlexPersistentVolumeSource {
    self.driver = driver;
    self
  }
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> V1FlexPersistentVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_options(mut self, options: ::std::collections::HashMap<String, String>) -> V1FlexPersistentVolumeSource {
    self.options = Some(options);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> V1FlexPersistentVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::V1SecretReference) -> V1FlexPersistentVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }
