...
pub struct V1DaemonSetSpec {
  ...
  update_strategy: Option<::models::V1DaemonSetUpdateStrategy>
}

impl V1DaemonSetSpec {
  /// DaemonSetSpec is the specification of a daemon set.
  pub fn new(selector: ::models::V1LabelSelector, template: ::models::V1PodTemplateSpec) -> V1DaemonSetSpec {
    V1DaemonSetSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> V1DaemonSetSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_revision_history_limit(mut self, revision_history_limit: i32) -> V1DaemonSetSpec {
    self.revision_history_limit = Some(revision_history_limit);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::V1LabelSelector) -> V1DaemonSetSpec {
    self.selector = selector;
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::V1PodTemplateSpec) -> V1DaemonSetSpec {
    self.template = template;
    self
  }
  ...
  pub fn set_update_strategy(&mut self, update_strategy: ::models::V1DaemonSetUpdateStrategy) {
    self.update_strategy = Some(update_strategy);
  }

  pub fn with_update_strategy(mut self, update_strategy: ::models::V1DaemonSetUpdateStrategy) -> V1DaemonSetSpec {
    self.update_strategy = Some(update_strategy);
    self
  }

  pub fn update_strategy(&self) -> Option<&::models::V1DaemonSetUpdateStrategy> {
