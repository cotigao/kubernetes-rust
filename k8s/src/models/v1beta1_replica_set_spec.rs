...
pub struct V1beta1ReplicaSetSpec {
...
impl V1beta1ReplicaSetSpec {
  /// ReplicaSetSpec is the specification of a ReplicaSet.
  pub fn new() -> V1beta1ReplicaSetSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> V1beta1ReplicaSetSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1beta1ReplicaSetSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::V1LabelSelector) -> V1beta1ReplicaSetSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::V1PodTemplateSpec) -> V1beta1ReplicaSetSpec {
    self.template = Some(template);
    self
  }
