...
impl V1beta1JobTemplateSpec {
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> V1beta1JobTemplateSpec {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_spec(mut self, spec: ::models::V1JobSpec) -> V1beta1JobTemplateSpec {
    self.spec = Some(spec);
    self
  }
