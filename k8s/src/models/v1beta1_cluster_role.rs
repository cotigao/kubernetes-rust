...
pub struct V1beta1ClusterRole {
  ...
  aggregation_rule: Option<::models::V1beta1AggregationRule>,
...
impl V1beta1ClusterRole {
  ...
  pub fn set_aggregation_rule(&mut self, aggregation_rule: ::models::V1beta1AggregationRule) {
    self.aggregation_rule = Some(aggregation_rule);
  }

  pub fn with_aggregation_rule(mut self, aggregation_rule: ::models::V1beta1AggregationRule) -> V1beta1ClusterRole {
    self.aggregation_rule = Some(aggregation_rule);
    self
  }

  pub fn aggregation_rule(&self) -> Option<&::models::V1beta1AggregationRule> {
