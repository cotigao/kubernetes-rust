...
impl V1beta1SubjectAccessReview {
  ...
  pub fn new(spec: ::models::V1beta1SubjectAccessReviewSpec) -> V1beta1SubjectAccessReview {
  ...
  pub fn with_api_version(mut self, api_version: String) -> V1beta1SubjectAccessReview {
    self.api_version = Some(api_version);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1beta1SubjectAccessReview {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> V1beta1SubjectAccessReview {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_spec(mut self, spec: ::models::V1beta1SubjectAccessReviewSpec) -> V1beta1SubjectAccessReview {
    self.spec = spec;
    self
  }
  ...
  pub fn with_status(mut self, status: ::models::V1beta1SubjectAccessReviewStatus) -> V1beta1SubjectAccessReview {
    self.status = Some(status);
    self
  }
