...
impl V1beta1CertificateSigningRequestSpec {
  ...
  pub fn with_extra(mut self, extra: ::std::collections::HashMap<String, Vec<String>>) -> V1beta1CertificateSigningRequestSpec {
    self.extra = Some(extra);
    self
  }
  ...
  pub fn with_groups(mut self, groups: Vec<String>) -> V1beta1CertificateSigningRequestSpec {
    self.groups = Some(groups);
    self
  }
  ...
  pub fn with_request(mut self, request: String) -> V1beta1CertificateSigningRequestSpec {
    self.request = request;
    self
  }
  ...
  pub fn with_uid(mut self, uid: String) -> V1beta1CertificateSigningRequestSpec {
    self.uid = Some(uid);
    self
  }
  ...
  pub fn with_usages(mut self, usages: Vec<String>) -> V1beta1CertificateSigningRequestSpec {
    self.usages = Some(usages);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> V1beta1CertificateSigningRequestSpec {
    self.username = Some(username);
    self
  }
