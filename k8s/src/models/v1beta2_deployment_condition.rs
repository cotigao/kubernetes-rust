...
pub struct V1beta2DeploymentCondition {
...
impl V1beta2DeploymentCondition {
  /// DeploymentCondition describes the state of a deployment at a certain point.
  pub fn new(status: String, _type: String) -> V1beta2DeploymentCondition {
  ...
  pub fn with_last_transition_time(mut self, last_transition_time: String) -> V1beta2DeploymentCondition {
    self.last_transition_time = Some(last_transition_time);
    self
  }
  ...
  pub fn with_last_update_time(mut self, last_update_time: String) -> V1beta2DeploymentCondition {
    self.last_update_time = Some(last_update_time);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> V1beta2DeploymentCondition {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_reason(mut self, reason: String) -> V1beta2DeploymentCondition {
    self.reason = Some(reason);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> V1beta2DeploymentCondition {
    self.status = status;
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> V1beta2DeploymentCondition {
    self._type = _type;
    self
  }
