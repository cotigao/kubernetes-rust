...
impl V1CephFsPersistentVolumeSource {
  ...
  pub fn with_monitors(mut self, monitors: Vec<String>) -> V1CephFsPersistentVolumeSource {
    self.monitors = monitors;
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> V1CephFsPersistentVolumeSource {
    self.path = Some(path);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> V1CephFsPersistentVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_file(mut self, secret_file: String) -> V1CephFsPersistentVolumeSource {
    self.secret_file = Some(secret_file);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::V1SecretReference) -> V1CephFsPersistentVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }
  ...
  pub fn with_user(mut self, user: String) -> V1CephFsPersistentVolumeSource {
    self.user = Some(user);
    self
  }
