...
pub struct V1PodSpec {
  /// Optional duration in seconds the pod may be active on the node relative to StartTime before the system will actively try to mark it failed and kill associated containers. ::serde_json::Value must be a positive integer.
  ...
  dns_config: Option<::models::V1PodDnsConfig>,
  ...
  readiness_gates: Option<Vec<::models::V1PodReadinessGate>>,
...
impl V1PodSpec {
  ...
  pub fn set_dns_config(&mut self, dns_config: ::models::V1PodDnsConfig) {
    self.dns_config = Some(dns_config);
  }

  pub fn with_dns_config(mut self, dns_config: ::models::V1PodDnsConfig) -> V1PodSpec {
    self.dns_config = Some(dns_config);
    self
  }

  pub fn dns_config(&self) -> Option<&::models::V1PodDnsConfig> {
  ...
  pub fn with_priority(mut self, priority: i32) -> V1PodSpec {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_priority_class_name(mut self, priority_class_name: String) -> V1PodSpec {
    self.priority_class_name = Some(priority_class_name);
    self
  }
  ...
  pub fn set_readiness_gates(&mut self, readiness_gates: Vec<::models::V1PodReadinessGate>) {
    self.readiness_gates = Some(readiness_gates);
  }

  pub fn with_readiness_gates(mut self, readiness_gates: Vec<::models::V1PodReadinessGate>) -> V1PodSpec {
    self.readiness_gates = Some(readiness_gates);
    self
  }

  pub fn readiness_gates(&self) -> Option<&Vec<::models::V1PodReadinessGate>> {
  ...
  pub fn with_runtime_class_name(mut self, runtime_class_name: String) -> V1PodSpec {
    self.runtime_class_name = Some(runtime_class_name);
    self
  }
  ...
  pub fn with_share_process_namespace(mut self, share_process_namespace: bool) -> V1PodSpec {
    self.share_process_namespace = Some(share_process_namespace);
    self
  }
