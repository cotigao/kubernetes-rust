...
impl V1HorizontalPodAutoscalerStatus {
  ...
  pub fn with_current_cpu_utilization_percentage(mut self, current_cpu_utilization_percentage: i32) -> V1HorizontalPodAutoscalerStatus {
    self.current_cpu_utilization_percentage = Some(current_cpu_utilization_percentage);
    self
  }
  ...
  pub fn with_current_replicas(mut self, current_replicas: i32) -> V1HorizontalPodAutoscalerStatus {
    self.current_replicas = current_replicas;
    self
  }
  ...
  pub fn with_desired_replicas(mut self, desired_replicas: i32) -> V1HorizontalPodAutoscalerStatus {
    self.desired_replicas = desired_replicas;
    self
  }
  ...
  pub fn with_last_scale_time(mut self, last_scale_time: String) -> V1HorizontalPodAutoscalerStatus {
    self.last_scale_time = Some(last_scale_time);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> V1HorizontalPodAutoscalerStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
