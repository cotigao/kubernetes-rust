...
impl V1beta1ApiServiceSpec {
  ...
  pub fn new(group_priority_minimum: i32, service: ::models::ApiregistrationV1beta1ServiceReference, version_priority: i32) -> V1beta1ApiServiceSpec {
  ...
  pub fn set_service(&mut self, service: ::models::ApiregistrationV1beta1ServiceReference) {
    self.service = service;
  }

  pub fn with_service(mut self, service: ::models::ApiregistrationV1beta1ServiceReference) -> V1beta1ApiServiceSpec {
    self.service = service;
    self
  }

  pub fn service(&self) -> &::models::ApiregistrationV1beta1ServiceReference {
    &self.service
  }
