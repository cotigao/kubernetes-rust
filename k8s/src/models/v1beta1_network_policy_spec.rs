...
/// V1beta1NetworkPolicySpec : DEPRECATED 1.9 - This group version of NetworkPolicySpec is deprecated by networking/v1/NetworkPolicySpec.
...
pub struct V1beta1NetworkPolicySpec {
  ...
  #[serde(rename = "egress")]
  egress: Option<Vec<::models::V1beta1NetworkPolicyEgressRule>>,
...
impl V1beta1NetworkPolicySpec {
  ...
  pub fn set_egress(&mut self, egress: Vec<::models::V1beta1NetworkPolicyEgressRule>) {
    self.egress = Some(egress);
  }

  pub fn with_egress(mut self, egress: Vec<::models::V1beta1NetworkPolicyEgressRule>) -> V1beta1NetworkPolicySpec {
    self.egress = Some(egress);
    self
  }

  pub fn egress(&self) -> Option<&Vec<::models::V1beta1NetworkPolicyEgressRule>> {
    self.egress.as_ref()
  }
  ...
  pub fn with_policy_types(mut self, policy_types: Vec<String>) -> V1beta1NetworkPolicySpec {
    self.policy_types = Some(policy_types);
    self
  }
