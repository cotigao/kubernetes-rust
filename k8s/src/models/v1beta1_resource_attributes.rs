...
impl V1beta1ResourceAttributes {
  ...
  pub fn with_group(mut self, group: String) -> V1beta1ResourceAttributes {
    self.group = Some(group);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> V1beta1ResourceAttributes {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_namespace(mut self, namespace: String) -> V1beta1ResourceAttributes {
    self.namespace = Some(namespace);
    self
  }
  ...
  pub fn with_resource(mut self, resource: String) -> V1beta1ResourceAttributes {
    self.resource = Some(resource);
    self
  }
  ...
  pub fn with_subresource(mut self, subresource: String) -> V1beta1ResourceAttributes {
    self.subresource = Some(subresource);
    self
  }
  ...
  pub fn with_verb(mut self, verb: String) -> V1beta1ResourceAttributes {
    self.verb = Some(verb);
    self
  }
  ...
  pub fn with_version(mut self, version: String) -> V1beta1ResourceAttributes {
    self.version = Some(version);
    self
  }
