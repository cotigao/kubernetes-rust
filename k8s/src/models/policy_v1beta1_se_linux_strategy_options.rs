...
pub struct PolicyV1beta1SeLinuxStrategyOptions {
...
impl PolicyV1beta1SeLinuxStrategyOptions {
  /// SELinuxStrategyOptions defines the strategy type and any options used to create the strategy.
  pub fn new(rule: String) -> PolicyV1beta1SeLinuxStrategyOptions {
  ...
  pub fn with_rule(mut self, rule: String) -> PolicyV1beta1SeLinuxStrategyOptions {
    self.rule = rule;
    self
  }
  ...
  pub fn with_se_linux_options(mut self, se_linux_options: ::models::V1SeLinuxOptions) -> PolicyV1beta1SeLinuxStrategyOptions {
    self.se_linux_options = Some(se_linux_options);
    self
  }
