...
**value_from** | [***::models::V1EnvVarSource**](v1.EnvVarSource.md) | Source for the environment variable&#39;s value. Cannot be used if value is not empty. | [optional] [default to null]
