...
**conditions** | [**Vec<::models::V1DaemonSetCondition>**](v1.DaemonSetCondition.md) | Represents the latest available observations of a DaemonSet&#39;s current state. | [optional] [default to null]
