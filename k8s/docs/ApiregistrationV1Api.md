...
# **create_api_service**
> ::models::V1ApiService create_api_service(ctx, body, optional)
...
[**::models::V1ApiService**](v1.APIService.md)
...
# **list_api_service**
> ::models::V1ApiServiceList list_api_service(ctx, optional)
...
[**::models::V1ApiServiceList**](v1.APIServiceList.md)
...
# **patch_api_service**
> ::models::V1ApiService patch_api_service(ctx, name, body, optional)
...
> ::models::V1ApiService patch_api_service_status(ctx, name, body, optional)
...
# **read_api_service**
> ::models::V1ApiService read_api_service(ctx, name, optional)
...
> ::models::V1ApiService read_api_service_status(ctx, name, optional)
...
# **replace_api_service**
> ::models::V1ApiService replace_api_service(ctx, name, body, optional)
...
> ::models::V1ApiService replace_api_service_status(ctx, name, body, optional)
