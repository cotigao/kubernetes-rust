...
> ::models::V1beta1CustomResourceDefinition create_custom_resource_definition(ctx, body, optional)
...
[**::models::V1beta1CustomResourceDefinition**](v1beta1.CustomResourceDefinition.md)
...
> ::models::V1Status delete_collection_custom_resource_definition(ctx, optional)
...
> ::models::V1Status delete_custom_resource_definition(ctx, name, body, optional)
...
> ::models::V1beta1CustomResourceDefinitionList list_custom_resource_definition(ctx, optional)
...
[**::models::V1beta1CustomResourceDefinitionList**](v1beta1.CustomResourceDefinitionList.md)
...
> ::models::V1beta1CustomResourceDefinition patch_custom_resource_definition(ctx, name, body, optional)
...
> ::models::V1beta1CustomResourceDefinition patch_custom_resource_definition_status(ctx, name, body, optional)
...
> ::models::V1beta1CustomResourceDefinition read_custom_resource_definition(ctx, name, optional)
...
> ::models::V1beta1CustomResourceDefinition read_custom_resource_definition_status(ctx, name, optional)
...
> ::models::V1beta1CustomResourceDefinition replace_custom_resource_definition(ctx, name, body, optional)
...
> ::models::V1beta1CustomResourceDefinition replace_custom_resource_definition_status(ctx, name, body, optional)
