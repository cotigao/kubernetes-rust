...
> ::models::V2beta2HorizontalPodAutoscaler create_namespaced_horizontal_pod_autoscaler(ctx, namespace, body, optional)
...
[**::models::V2beta2HorizontalPodAutoscaler**](v2beta2.HorizontalPodAutoscaler.md)
...
> ::models::V2beta2HorizontalPodAutoscalerList list_horizontal_pod_autoscaler_for_all_namespaces(ctx, optional)
...
[**::models::V2beta2HorizontalPodAutoscalerList**](v2beta2.HorizontalPodAutoscalerList.md)
...
> ::models::V2beta2HorizontalPodAutoscalerList list_namespaced_horizontal_pod_autoscaler(ctx, namespace, optional)
...
> ::models::V2beta2HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler(ctx, name, namespace, body, optional)
...
> ::models::V2beta2HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler_status(ctx, name, namespace, body, optional)
...
> ::models::V2beta2HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler(ctx, name, namespace, optional)
...
> ::models::V2beta2HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler_status(ctx, name, namespace, optional)
...
> ::models::V2beta2HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler(ctx, name, namespace, body, optional)
...
> ::models::V2beta2HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler_status(ctx, name, namespace, body, optional)
