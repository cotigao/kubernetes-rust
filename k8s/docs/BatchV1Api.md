...
> ::models::V1Job create_namespaced_job(ctx, namespace, body, optional)
...
> ::models::V1Status delete_collection_namespaced_job(ctx, namespace, optional)
...
> ::models::V1Status delete_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::V1JobList list_job_for_all_namespaces(ctx, optional)
...
[**::models::V1JobList**](v1.JobList.md)
...
# **list_namespaced_job**
> ::models::V1JobList list_namespaced_job(ctx, namespace, optional)
...
> ::models::V1Job patch_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::V1Job patch_namespaced_job_status(ctx, name, namespace, body, optional)
...
# **read_namespaced_job**
> ::models::V1Job read_namespaced_job(ctx, name, namespace, optional)
...
> ::models::V1Job read_namespaced_job_status(ctx, name, namespace, optional)
...
> ::models::V1Job replace_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::V1Job replace_namespaced_job_status(ctx, name, namespace, body, optional)
