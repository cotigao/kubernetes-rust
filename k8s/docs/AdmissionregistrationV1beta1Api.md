...
> ::models::V1beta1MutatingWebhookConfiguration create_mutating_webhook_configuration(ctx, body, optional)
...
[**::models::V1beta1MutatingWebhookConfiguration**](v1beta1.MutatingWebhookConfiguration.md)
...
> ::models::V1beta1ValidatingWebhookConfiguration create_validating_webhook_configuration(ctx, body, optional)
...
[**::models::V1beta1ValidatingWebhookConfiguration**](v1beta1.ValidatingWebhookConfiguration.md)
...
> ::models::V1Status delete_collection_mutating_webhook_configuration(ctx, optional)
...
> ::models::V1Status delete_collection_validating_webhook_configuration(ctx, optional)
...
> ::models::V1Status delete_mutating_webhook_configuration(ctx, name, body, optional)
...
> ::models::V1Status delete_validating_webhook_configuration(ctx, name, body, optional)
...
> ::models::V1beta1MutatingWebhookConfigurationList list_mutating_webhook_configuration(ctx, optional)
...
[**::models::V1beta1MutatingWebhookConfigurationList**](v1beta1.MutatingWebhookConfigurationList.md)
...
> ::models::V1beta1ValidatingWebhookConfigurationList list_validating_webhook_configuration(ctx, optional)
...
[**::models::V1beta1ValidatingWebhookConfigurationList**](v1beta1.ValidatingWebhookConfigurationList.md)
...
> ::models::V1beta1MutatingWebhookConfiguration patch_mutating_webhook_configuration(ctx, name, body, optional)
...
> ::models::V1beta1ValidatingWebhookConfiguration patch_validating_webhook_configuration(ctx, name, body, optional)
...
> ::models::V1beta1MutatingWebhookConfiguration read_mutating_webhook_configuration(ctx, name, optional)
...
> ::models::V1beta1ValidatingWebhookConfiguration read_validating_webhook_configuration(ctx, name, optional)
...
> ::models::V1beta1MutatingWebhookConfiguration replace_mutating_webhook_configuration(ctx, name, body, optional)
...
> ::models::V1beta1ValidatingWebhookConfiguration replace_validating_webhook_configuration(ctx, name, body, optional)
