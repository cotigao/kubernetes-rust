...
> ::models::V1alpha1PodPreset create_namespaced_pod_preset(ctx, namespace, body, optional)
...
[**::models::V1alpha1PodPreset**](v1alpha1.PodPreset.md)
...
> ::models::V1Status delete_collection_namespaced_pod_preset(ctx, namespace, optional)
...
> ::models::V1Status delete_namespaced_pod_preset(ctx, name, namespace, body, optional)
...
> ::models::V1alpha1PodPresetList list_namespaced_pod_preset(ctx, namespace, optional)
...
[**::models::V1alpha1PodPresetList**](v1alpha1.PodPresetList.md)
...
> ::models::V1alpha1PodPresetList list_pod_preset_for_all_namespaces(ctx, optional)
...
> ::models::V1alpha1PodPreset patch_namespaced_pod_preset(ctx, name, namespace, body, optional)
...
> ::models::V1alpha1PodPreset read_namespaced_pod_preset(ctx, name, namespace, optional)
...
> ::models::V1alpha1PodPreset replace_namespaced_pod_preset(ctx, name, namespace, body, optional)
