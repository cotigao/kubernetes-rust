...
> ::models::V1beta1Lease create_namespaced_lease(ctx, namespace, body, optional)
...
[**::models::V1beta1Lease**](v1beta1.Lease.md)
...
> ::models::V1Status delete_collection_namespaced_lease(ctx, namespace, optional)
...
> ::models::V1Status delete_namespaced_lease(ctx, name, namespace, body, optional)
...
> ::models::V1beta1LeaseList list_lease_for_all_namespaces(ctx, optional)
...
[**::models::V1beta1LeaseList**](v1beta1.LeaseList.md)
...
> ::models::V1beta1LeaseList list_namespaced_lease(ctx, namespace, optional)
...
> ::models::V1beta1Lease patch_namespaced_lease(ctx, name, namespace, body, optional)
...
> ::models::V1beta1Lease read_namespaced_lease(ctx, name, namespace, optional)
...
> ::models::V1beta1Lease replace_namespaced_lease(ctx, name, namespace, body, optional)
