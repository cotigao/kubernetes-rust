...
impl V1PolicyRule {
  ...
  pub fn with_api_groups(mut self, api_groups: Vec<String>) -> V1PolicyRule {
    self.api_groups = Some(api_groups);
    self
  }
  ...
  pub fn with_non_resource_ur_ls(mut self, non_resource_ur_ls: Vec<String>) -> V1PolicyRule {
    self.non_resource_ur_ls = Some(non_resource_ur_ls);
    self
  }
  ...
  pub fn with_resource_names(mut self, resource_names: Vec<String>) -> V1PolicyRule {
    self.resource_names = Some(resource_names);
    self
  }
  ...
  pub fn with_resources(mut self, resources: Vec<String>) -> V1PolicyRule {
    self.resources = Some(resources);
    self
  }
  ...
  pub fn with_verbs(mut self, verbs: Vec<String>) -> V1PolicyRule {
    self.verbs = verbs;
    self
  }
