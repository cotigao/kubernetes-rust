...
pub struct V1HorizontalPodAutoscalerSpec {
  ...
  scale_target_ref: ::models::V1CrossVersionObjectReference,
...
impl V1HorizontalPodAutoscalerSpec {
  ...
  pub fn new(max_replicas: i32, scale_target_ref: ::models::V1CrossVersionObjectReference) -> V1HorizontalPodAutoscalerSpec {
  ...
  pub fn with_max_replicas(mut self, max_replicas: i32) -> V1HorizontalPodAutoscalerSpec {
    self.max_replicas = max_replicas;
    self
  }
  ...
  pub fn with_min_replicas(mut self, min_replicas: i32) -> V1HorizontalPodAutoscalerSpec {
    self.min_replicas = Some(min_replicas);
    self
  }
  ...
  pub fn set_scale_target_ref(&mut self, scale_target_ref: ::models::V1CrossVersionObjectReference) {
    self.scale_target_ref = scale_target_ref;
  }

  pub fn with_scale_target_ref(mut self, scale_target_ref: ::models::V1CrossVersionObjectReference) -> V1HorizontalPodAutoscalerSpec {
    self.scale_target_ref = scale_target_ref;
    self
  }

  pub fn scale_target_ref(&self) -> &::models::V1CrossVersionObjectReference {
  ...
  pub fn with_target_cpu_utilization_percentage(mut self, target_cpu_utilization_percentage: i32) -> V1HorizontalPodAutoscalerSpec {
    self.target_cpu_utilization_percentage = Some(target_cpu_utilization_percentage);
    self
  }
