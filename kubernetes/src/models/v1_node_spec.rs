...
pub struct V1NodeSpec {
  ...
  config_source: Option<::models::V1NodeConfigSource>,
...
impl V1NodeSpec {
  ...
  pub fn set_config_source(&mut self, config_source: ::models::V1NodeConfigSource) {
    self.config_source = Some(config_source);
  }

  pub fn with_config_source(mut self, config_source: ::models::V1NodeConfigSource) -> V1NodeSpec {
    self.config_source = Some(config_source);
    self
  }

  pub fn config_source(&self) -> Option<&::models::V1NodeConfigSource> {
