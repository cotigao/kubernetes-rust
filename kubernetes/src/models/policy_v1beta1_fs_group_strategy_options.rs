...
pub struct PolicyV1beta1FsGroupStrategyOptions {
...
impl PolicyV1beta1FsGroupStrategyOptions {
  /// FSGroupStrategyOptions defines the strategy type and options used to create the strategy.
  pub fn new() -> PolicyV1beta1FsGroupStrategyOptions {
  ...
  pub fn with_ranges(mut self, ranges: Vec<::models::PolicyV1beta1IdRange>) -> PolicyV1beta1FsGroupStrategyOptions {
    self.ranges = Some(ranges);
    self
  }
  ...
  pub fn with_rule(mut self, rule: String) -> PolicyV1beta1FsGroupStrategyOptions {
    self.rule = Some(rule);
    self
  }
