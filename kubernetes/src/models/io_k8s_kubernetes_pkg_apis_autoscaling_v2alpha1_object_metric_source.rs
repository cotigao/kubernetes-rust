...
pub struct IoK8sKubernetesPkgApisAutoscalingV2alpha1ObjectMetricSource {
  ...
  target_value: ::models::IoK8sApimachineryPkgApiResourceQuantity
}

impl IoK8sKubernetesPkgApisAutoscalingV2alpha1ObjectMetricSource {
  /// ObjectMetricSource indicates how to scale on a metric describing a kubernetes object (for example, hits-per-second on an Ingress object).
  pub fn new(metric_name: String, target: ::models::IoK8sKubernetesPkgApisAutoscalingV2alpha1CrossVersionObjectReference, target_value: ::models::IoK8sApimachineryPkgApiResourceQuantity) -> IoK8sKubernetesPkgApisAutoscalingV2alpha1ObjectMetricSource {
  ...
  pub fn set_target_value(&mut self, target_value: ::models::IoK8sApimachineryPkgApiResourceQuantity) {
    self.target_value = target_value;
  }

  pub fn with_target_value(mut self, target_value: ::models::IoK8sApimachineryPkgApiResourceQuantity) -> IoK8sKubernetesPkgApisAutoscalingV2alpha1ObjectMetricSource {
    self.target_value = target_value;
    self
  }

  pub fn target_value(&self) -> &::models::IoK8sApimachineryPkgApiResourceQuantity {
    &self.target_value
  }
