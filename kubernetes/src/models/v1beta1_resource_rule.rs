...
impl V1beta1ResourceRule {
  ...
  pub fn with_api_groups(mut self, api_groups: Vec<String>) -> V1beta1ResourceRule {
    self.api_groups = Some(api_groups);
    self
  }
  ...
  pub fn with_resource_names(mut self, resource_names: Vec<String>) -> V1beta1ResourceRule {
    self.resource_names = Some(resource_names);
    self
  }
  ...
  pub fn with_resources(mut self, resources: Vec<String>) -> V1beta1ResourceRule {
    self.resources = Some(resources);
    self
  }
  ...
  pub fn with_verbs(mut self, verbs: Vec<String>) -> V1beta1ResourceRule {
    self.verbs = verbs;
    self
  }
