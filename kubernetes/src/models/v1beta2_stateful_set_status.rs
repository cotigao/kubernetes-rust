...
impl V1beta2StatefulSetStatus {
  /// StatefulSetStatus represents the current state of a StatefulSet.
  pub fn new(replicas: i32) -> V1beta2StatefulSetStatus {
  ...
  pub fn with_collision_count(mut self, collision_count: i32) -> V1beta2StatefulSetStatus {
    self.collision_count = Some(collision_count);
    self
  }
  ...
  pub fn set_conditions(&mut self, conditions: Vec<::models::V1beta2StatefulSetCondition>) {
    self.conditions = Some(conditions);
  }

  pub fn with_conditions(mut self, conditions: Vec<::models::V1beta2StatefulSetCondition>) -> V1beta2StatefulSetStatus {
    self.conditions = Some(conditions);
    self
  }

  pub fn conditions(&self) -> Option<&Vec<::models::V1beta2StatefulSetCondition>> {
  ...
  pub fn with_current_replicas(mut self, current_replicas: i32) -> V1beta2StatefulSetStatus {
    self.current_replicas = Some(current_replicas);
    self
  }
  ...
  pub fn with_current_revision(mut self, current_revision: String) -> V1beta2StatefulSetStatus {
    self.current_revision = Some(current_revision);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> V1beta2StatefulSetStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
  ...
  pub fn with_ready_replicas(mut self, ready_replicas: i32) -> V1beta2StatefulSetStatus {
    self.ready_replicas = Some(ready_replicas);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1beta2StatefulSetStatus {
    self.replicas = replicas;
    self
  }
  ...
  pub fn with_update_revision(mut self, update_revision: String) -> V1beta2StatefulSetStatus {
    self.update_revision = Some(update_revision);
    self
  }
  ...
  pub fn with_updated_replicas(mut self, updated_replicas: i32) -> V1beta2StatefulSetStatus {
    self.updated_replicas = Some(updated_replicas);
    self
  }
