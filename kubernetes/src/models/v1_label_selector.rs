...
pub struct V1LabelSelector {
  ...
  match_expressions: Option<Vec<::models::V1LabelSelectorRequirement>>,
...
impl V1LabelSelector {
  ...
  pub fn set_match_expressions(&mut self, match_expressions: Vec<::models::V1LabelSelectorRequirement>) {
    self.match_expressions = Some(match_expressions);
  }

  pub fn with_match_expressions(mut self, match_expressions: Vec<::models::V1LabelSelectorRequirement>) -> V1LabelSelector {
    self.match_expressions = Some(match_expressions);
    self
  }

  pub fn match_expressions(&self) -> Option<&Vec<::models::V1LabelSelectorRequirement>> {
  ...
  pub fn with_match_labels(mut self, match_labels: ::std::collections::HashMap<String, String>) -> V1LabelSelector {
    self.match_labels = Some(match_labels);
    self
  }
