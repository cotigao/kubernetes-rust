...
/// IoK8sKubernetesPkgApisNetworkingV1NetworkPolicyPeer : NetworkPolicyPeer describes a peer to allow traffic from. Exactly one of its fields must be specified.
...
impl IoK8sKubernetesPkgApisNetworkingV1NetworkPolicyPeer {
  ...
  pub fn with_namespace_selector(mut self, namespace_selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sKubernetesPkgApisNetworkingV1NetworkPolicyPeer {
    self.namespace_selector = Some(namespace_selector);
    self
  }
  ...
  pub fn with_pod_selector(mut self, pod_selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sKubernetesPkgApisNetworkingV1NetworkPolicyPeer {
    self.pod_selector = Some(pod_selector);
    self
  }
