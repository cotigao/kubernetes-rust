...
impl V1beta2ReplicaSetStatus {
  /// ReplicaSetStatus represents the current status of a ReplicaSet.
  pub fn new(replicas: i32) -> V1beta2ReplicaSetStatus {
  ...
  pub fn with_available_replicas(mut self, available_replicas: i32) -> V1beta2ReplicaSetStatus {
    self.available_replicas = Some(available_replicas);
    self
  }
  ...
  pub fn set_conditions(&mut self, conditions: Vec<::models::V1beta2ReplicaSetCondition>) {
    self.conditions = Some(conditions);
  }

  pub fn with_conditions(mut self, conditions: Vec<::models::V1beta2ReplicaSetCondition>) -> V1beta2ReplicaSetStatus {
    self.conditions = Some(conditions);
    self
  }

  pub fn conditions(&self) -> Option<&Vec<::models::V1beta2ReplicaSetCondition>> {
  ...
  pub fn with_fully_labeled_replicas(mut self, fully_labeled_replicas: i32) -> V1beta2ReplicaSetStatus {
    self.fully_labeled_replicas = Some(fully_labeled_replicas);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> V1beta2ReplicaSetStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
  ...
  pub fn with_ready_replicas(mut self, ready_replicas: i32) -> V1beta2ReplicaSetStatus {
    self.ready_replicas = Some(ready_replicas);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1beta2ReplicaSetStatus {
    self.replicas = replicas;
    self
  }
