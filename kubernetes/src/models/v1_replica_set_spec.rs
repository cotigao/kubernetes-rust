...
impl V1ReplicaSetSpec {
  ...
  pub fn new(selector: ::models::V1LabelSelector) -> V1ReplicaSetSpec {
    V1ReplicaSetSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> V1ReplicaSetSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1ReplicaSetSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::V1LabelSelector) -> V1ReplicaSetSpec {
    self.selector = selector;
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::V1PodTemplateSpec) -> V1ReplicaSetSpec {
    self.template = Some(template);
    self
  }
