...
/// IoK8sKubernetesPkgApiV1ReplicationControllerSpec : ReplicationControllerSpec is the specification of a replication controller.
...
impl IoK8sKubernetesPkgApiV1ReplicationControllerSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> IoK8sKubernetesPkgApiV1ReplicationControllerSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> IoK8sKubernetesPkgApiV1ReplicationControllerSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::std::collections::HashMap<String, String>) -> IoK8sKubernetesPkgApiV1ReplicationControllerSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::IoK8sKubernetesPkgApiV1PodTemplateSpec) -> IoK8sKubernetesPkgApiV1ReplicationControllerSpec {
    self.template = Some(template);
    self
  }
