...
/// IoK8sKubernetesPkgApiV1Handler : Handler defines a specific action that should be taken
...
impl IoK8sKubernetesPkgApiV1Handler {
  ...
  pub fn with_exec(mut self, exec: ::models::IoK8sKubernetesPkgApiV1ExecAction) -> IoK8sKubernetesPkgApiV1Handler {
    self.exec = Some(exec);
    self
  }
  ...
  pub fn with_http_get(mut self, http_get: ::models::IoK8sKubernetesPkgApiV1HttpGetAction) -> IoK8sKubernetesPkgApiV1Handler {
    self.http_get = Some(http_get);
    self
  }
  ...
  pub fn with_tcp_socket(mut self, tcp_socket: ::models::IoK8sKubernetesPkgApiV1TcpSocketAction) -> IoK8sKubernetesPkgApiV1Handler {
    self.tcp_socket = Some(tcp_socket);
    self
  }
