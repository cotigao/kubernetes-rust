...
impl IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus {
  ...
  pub fn new(current_healthy: i32, desired_healthy: i32, disrupted_pods: ::std::collections::HashMap<String, String>, disruptions_allowed: i32, expected_pods: i32) -> IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus {
  ...
  pub fn with_disrupted_pods(mut self, disrupted_pods: ::std::collections::HashMap<String, String>) -> IoK8sKubernetesPkgApisPolicyV1beta1PodDisruptionBudgetStatus {
    self.disrupted_pods = disrupted_pods;
    self
  }
