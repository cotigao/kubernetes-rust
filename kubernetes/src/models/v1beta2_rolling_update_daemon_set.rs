...
pub struct V1beta2RollingUpdateDaemonSet {
...
impl V1beta2RollingUpdateDaemonSet {
  /// Spec to control the desired behavior of daemon set rolling update.
  pub fn new() -> V1beta2RollingUpdateDaemonSet {
  ...
  pub fn with_max_unavailable(mut self, max_unavailable: ::serde_json::Value) -> V1beta2RollingUpdateDaemonSet {
    self.max_unavailable = Some(max_unavailable);
    self
  }
