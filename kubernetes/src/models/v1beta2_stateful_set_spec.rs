...
pub struct V1beta2StatefulSetSpec {
  ...
  update_strategy: Option<::models::V1beta2StatefulSetUpdateStrategy>,
...
impl V1beta2StatefulSetSpec {
  /// A StatefulSetSpec is the specification of a StatefulSet.
  pub fn new(selector: ::models::V1LabelSelector, service_name: String, template: ::models::V1PodTemplateSpec) -> V1beta2StatefulSetSpec {
  ...
  pub fn with_pod_management_policy(mut self, pod_management_policy: String) -> V1beta2StatefulSetSpec {
    self.pod_management_policy = Some(pod_management_policy);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1beta2StatefulSetSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_revision_history_limit(mut self, revision_history_limit: i32) -> V1beta2StatefulSetSpec {
    self.revision_history_limit = Some(revision_history_limit);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::V1LabelSelector) -> V1beta2StatefulSetSpec {
    self.selector = selector;
    self
  }
  ...
  pub fn with_service_name(mut self, service_name: String) -> V1beta2StatefulSetSpec {
    self.service_name = service_name;
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::V1PodTemplateSpec) -> V1beta2StatefulSetSpec {
    self.template = template;
    self
  }
  ...
  pub fn set_update_strategy(&mut self, update_strategy: ::models::V1beta2StatefulSetUpdateStrategy) {
    self.update_strategy = Some(update_strategy);
  }

  pub fn with_update_strategy(mut self, update_strategy: ::models::V1beta2StatefulSetUpdateStrategy) -> V1beta2StatefulSetSpec {
    self.update_strategy = Some(update_strategy);
    self
  }

  pub fn update_strategy(&self) -> Option<&::models::V1beta2StatefulSetUpdateStrategy> {
  ...
  pub fn with_volume_claim_templates(mut self, volume_claim_templates: Vec<::models::V1PersistentVolumeClaim>) -> V1beta2StatefulSetSpec {
    self.volume_claim_templates = Some(volume_claim_templates);
    self
  }
