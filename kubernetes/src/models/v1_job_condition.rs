...
impl V1JobCondition {
  ...
  pub fn with_last_probe_time(mut self, last_probe_time: String) -> V1JobCondition {
    self.last_probe_time = Some(last_probe_time);
    self
  }
  ...
  pub fn with_last_transition_time(mut self, last_transition_time: String) -> V1JobCondition {
    self.last_transition_time = Some(last_transition_time);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> V1JobCondition {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_reason(mut self, reason: String) -> V1JobCondition {
    self.reason = Some(reason);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> V1JobCondition {
    self.status = status;
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> V1JobCondition {
    self._type = _type;
    self
  }
