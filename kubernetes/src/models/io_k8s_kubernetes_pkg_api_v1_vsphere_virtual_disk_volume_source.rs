...
/// IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource : Represents a vSphere volume resource.
...
impl IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource {
  ...
  pub fn new(volume_path: String) -> IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource {
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_storage_policy_id(mut self, storage_policy_id: String) -> IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource {
    self.storage_policy_id = Some(storage_policy_id);
    self
  }
  ...
  pub fn with_storage_policy_name(mut self, storage_policy_name: String) -> IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource {
    self.storage_policy_name = Some(storage_policy_name);
    self
  }
  ...
  pub fn with_volume_path(mut self, volume_path: String) -> IoK8sKubernetesPkgApiV1VsphereVirtualDiskVolumeSource {
    self.volume_path = volume_path;
    self
  }
