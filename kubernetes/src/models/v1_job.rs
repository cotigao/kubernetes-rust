...
pub struct V1Job {
  ...
  #[serde(rename = "status")]
  status: Option<::models::V1JobStatus>
}
...
impl V1Job {
  ...
  pub fn with_api_version(mut self, api_version: String) -> V1Job {
    self.api_version = Some(api_version);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1Job {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> V1Job {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_spec(mut self, spec: ::models::V1JobSpec) -> V1Job {
    self.spec = Some(spec);
    self
  }
  ...
  pub fn set_status(&mut self, status: ::models::V1JobStatus) {
    self.status = Some(status);
  }

  pub fn with_status(mut self, status: ::models::V1JobStatus) -> V1Job {
    self.status = Some(status);
    self
  }

  pub fn status(&self) -> Option<&::models::V1JobStatus> {
    self.status.as_ref()
  }
