...
pub struct V1StatusDetails {
  ...
  #[serde(rename = "causes")]
  causes: Option<Vec<::models::V1StatusCause>>,
...
impl V1StatusDetails {
  ...
  pub fn set_causes(&mut self, causes: Vec<::models::V1StatusCause>) {
    self.causes = Some(causes);
  }

  pub fn with_causes(mut self, causes: Vec<::models::V1StatusCause>) -> V1StatusDetails {
    self.causes = Some(causes);
    self
  }

  pub fn causes(&self) -> Option<&Vec<::models::V1StatusCause>> {
    self.causes.as_ref()
  }
  ...
  pub fn with_group(mut self, group: String) -> V1StatusDetails {
    self.group = Some(group);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1StatusDetails {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> V1StatusDetails {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_retry_after_seconds(mut self, retry_after_seconds: i32) -> V1StatusDetails {
    self.retry_after_seconds = Some(retry_after_seconds);
    self
  }
  ...
  pub fn with_uid(mut self, uid: String) -> V1StatusDetails {
    self.uid = Some(uid);
    self
  }
