...
impl V1beta2ScaleStatus {
  /// ScaleStatus represents the current status of a scale subresource.
  pub fn new(replicas: i32) -> V1beta2ScaleStatus {
    V1beta2ScaleStatus {
      replicas: replicas,
      selector: None,
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1beta2ScaleStatus {
    self.replicas = replicas;
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::std::collections::HashMap<String, String>) -> V1beta2ScaleStatus {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_target_selector(mut self, target_selector: String) -> V1beta2ScaleStatus {
    self.target_selector = Some(target_selector);
    self
  }
