...
/// IoK8sKubernetesPkgApiV1PodSpec : PodSpec is a description of a pod.
...
pub struct IoK8sKubernetesPkgApiV1PodSpec {
  ...
  affinity: Option<::models::IoK8sKubernetesPkgApiV1Affinity>,
  ...
  containers: Vec<::models::IoK8sKubernetesPkgApiV1Container>,
  ...
  host_aliases: Option<Vec<::models::IoK8sKubernetesPkgApiV1HostAlias>>,
  ...
  init_containers: Option<Vec<::models::IoK8sKubernetesPkgApiV1Container>>,
  ...
  security_context: Option<::models::IoK8sKubernetesPkgApiV1PodSecurityContext>,
  ...
  tolerations: Option<Vec<::models::IoK8sKubernetesPkgApiV1Toleration>>,
...
impl IoK8sKubernetesPkgApiV1PodSpec {
  ...
  pub fn new(containers: Vec<::models::IoK8sKubernetesPkgApiV1Container>) -> IoK8sKubernetesPkgApiV1PodSpec {
  ...
  pub fn with_active_deadline_seconds(mut self, active_deadline_seconds: i64) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.active_deadline_seconds = Some(active_deadline_seconds);
    self
  }
  ...
  pub fn set_affinity(&mut self, affinity: ::models::IoK8sKubernetesPkgApiV1Affinity) {
    self.affinity = Some(affinity);
  }

  pub fn with_affinity(mut self, affinity: ::models::IoK8sKubernetesPkgApiV1Affinity) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.affinity = Some(affinity);
    self
  }

  pub fn affinity(&self) -> Option<&::models::IoK8sKubernetesPkgApiV1Affinity> {
  ...
  pub fn with_automount_service_account_token(mut self, automount_service_account_token: bool) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.automount_service_account_token = Some(automount_service_account_token);
    self
  }
  ...
  pub fn set_containers(&mut self, containers: Vec<::models::IoK8sKubernetesPkgApiV1Container>) {
    self.containers = containers;
  }

  pub fn with_containers(mut self, containers: Vec<::models::IoK8sKubernetesPkgApiV1Container>) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.containers = containers;
    self
  }

  pub fn containers(&self) -> &Vec<::models::IoK8sKubernetesPkgApiV1Container> {
    &self.containers
  }
  ...
  pub fn with_dns_policy(mut self, dns_policy: String) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.dns_policy = Some(dns_policy);
    self
  }
  ...
  pub fn set_host_aliases(&mut self, host_aliases: Vec<::models::IoK8sKubernetesPkgApiV1HostAlias>) {
    self.host_aliases = Some(host_aliases);
  }

  pub fn with_host_aliases(mut self, host_aliases: Vec<::models::IoK8sKubernetesPkgApiV1HostAlias>) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.host_aliases = Some(host_aliases);
    self
  }

  pub fn host_aliases(&self) -> Option<&Vec<::models::IoK8sKubernetesPkgApiV1HostAlias>> {
  ...
  pub fn with_host_ipc(mut self, host_ipc: bool) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.host_ipc = Some(host_ipc);
    self
  }
  ...
  pub fn with_host_network(mut self, host_network: bool) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.host_network = Some(host_network);
    self
  }
  ...
  pub fn with_host_pid(mut self, host_pid: bool) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.host_pid = Some(host_pid);
    self
  }
  ...
  pub fn with_hostname(mut self, hostname: String) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.hostname = Some(hostname);
    self
  }
  ...
  pub fn with_image_pull_secrets(mut self, image_pull_secrets: Vec<::models::IoK8sKubernetesPkgApiV1LocalObjectReference>) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.image_pull_secrets = Some(image_pull_secrets);
    self
  }
  ...
  pub fn set_init_containers(&mut self, init_containers: Vec<::models::IoK8sKubernetesPkgApiV1Container>) {
    self.init_containers = Some(init_containers);
  }

  pub fn with_init_containers(mut self, init_containers: Vec<::models::IoK8sKubernetesPkgApiV1Container>) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.init_containers = Some(init_containers);
    self
  }

  pub fn init_containers(&self) -> Option<&Vec<::models::IoK8sKubernetesPkgApiV1Container>> {
  ...
  pub fn with_node_name(mut self, node_name: String) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.node_name = Some(node_name);
    self
  }
  ...
  pub fn with_node_selector(mut self, node_selector: ::std::collections::HashMap<String, String>) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.node_selector = Some(node_selector);
    self
  }
  ...
  pub fn with_restart_policy(mut self, restart_policy: String) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.restart_policy = Some(restart_policy);
    self
  }
  ...
  pub fn with_scheduler_name(mut self, scheduler_name: String) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.scheduler_name = Some(scheduler_name);
    self
  }
  ...
  pub fn set_security_context(&mut self, security_context: ::models::IoK8sKubernetesPkgApiV1PodSecurityContext) {
    self.security_context = Some(security_context);
  }

  pub fn with_security_context(mut self, security_context: ::models::IoK8sKubernetesPkgApiV1PodSecurityContext) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.security_context = Some(security_context);
    self
  }

  pub fn security_context(&self) -> Option<&::models::IoK8sKubernetesPkgApiV1PodSecurityContext> {
  ...
  pub fn with_service_account(mut self, service_account: String) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.service_account = Some(service_account);
    self
  }
  ...
  pub fn with_service_account_name(mut self, service_account_name: String) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.service_account_name = Some(service_account_name);
    self
  }
  ...
  pub fn with_subdomain(mut self, subdomain: String) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.subdomain = Some(subdomain);
    self
  }
  ...
  pub fn with_termination_grace_period_seconds(mut self, termination_grace_period_seconds: i64) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.termination_grace_period_seconds = Some(termination_grace_period_seconds);
    self
  }
  ...
  pub fn set_tolerations(&mut self, tolerations: Vec<::models::IoK8sKubernetesPkgApiV1Toleration>) {
    self.tolerations = Some(tolerations);
  }

  pub fn with_tolerations(mut self, tolerations: Vec<::models::IoK8sKubernetesPkgApiV1Toleration>) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.tolerations = Some(tolerations);
    self
  }

  pub fn tolerations(&self) -> Option<&Vec<::models::IoK8sKubernetesPkgApiV1Toleration>> {
  ...
  pub fn with_volumes(mut self, volumes: Vec<::models::IoK8sKubernetesPkgApiV1Volume>) -> IoK8sKubernetesPkgApiV1PodSpec {
    self.volumes = Some(volumes);
    self
  }
