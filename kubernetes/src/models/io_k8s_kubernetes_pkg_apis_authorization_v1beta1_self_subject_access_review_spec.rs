...
/// IoK8sKubernetesPkgApisAuthorizationV1beta1SelfSubjectAccessReviewSpec : SelfSubjectAccessReviewSpec is a description of the access request.  Exactly one of ResourceAuthorizationAttributes and NonResourceAuthorizationAttributes must be set
...
impl IoK8sKubernetesPkgApisAuthorizationV1beta1SelfSubjectAccessReviewSpec {
  ...
  pub fn with_non_resource_attributes(mut self, non_resource_attributes: ::models::IoK8sKubernetesPkgApisAuthorizationV1beta1NonResourceAttributes) -> IoK8sKubernetesPkgApisAuthorizationV1beta1SelfSubjectAccessReviewSpec {
    self.non_resource_attributes = Some(non_resource_attributes);
    self
  }
  ...
  pub fn with_resource_attributes(mut self, resource_attributes: ::models::IoK8sKubernetesPkgApisAuthorizationV1beta1ResourceAttributes) -> IoK8sKubernetesPkgApisAuthorizationV1beta1SelfSubjectAccessReviewSpec {
    self.resource_attributes = Some(resource_attributes);
    self
  }
