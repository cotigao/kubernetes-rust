...
pub struct V1alpha1PodPresetSpec {
...
impl V1alpha1PodPresetSpec {
  /// PodPresetSpec is a description of a pod preset.
  pub fn new() -> V1alpha1PodPresetSpec {
  ...
  pub fn with_env(mut self, env: Vec<::models::V1EnvVar>) -> V1alpha1PodPresetSpec {
    self.env = Some(env);
    self
  }
  ...
  pub fn with_env_from(mut self, env_from: Vec<::models::V1EnvFromSource>) -> V1alpha1PodPresetSpec {
    self.env_from = Some(env_from);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::V1LabelSelector) -> V1alpha1PodPresetSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_volume_mounts(mut self, volume_mounts: Vec<::models::V1VolumeMount>) -> V1alpha1PodPresetSpec {
    self.volume_mounts = Some(volume_mounts);
    self
  }
  ...
  pub fn with_volumes(mut self, volumes: Vec<::models::V1Volume>) -> V1alpha1PodPresetSpec {
    self.volumes = Some(volumes);
    self
  }
