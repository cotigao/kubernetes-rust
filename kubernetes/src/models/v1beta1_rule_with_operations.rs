...
impl V1beta1RuleWithOperations {
  ...
  pub fn with_api_groups(mut self, api_groups: Vec<String>) -> V1beta1RuleWithOperations {
    self.api_groups = Some(api_groups);
    self
  }
  ...
  pub fn with_api_versions(mut self, api_versions: Vec<String>) -> V1beta1RuleWithOperations {
    self.api_versions = Some(api_versions);
    self
  }
  ...
  pub fn with_operations(mut self, operations: Vec<String>) -> V1beta1RuleWithOperations {
    self.operations = Some(operations);
    self
  }
  ...
  pub fn with_resources(mut self, resources: Vec<String>) -> V1beta1RuleWithOperations {
    self.resources = Some(resources);
    self
  }
