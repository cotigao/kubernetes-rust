...
/// IoK8sKubernetesPkgApiV1IscsiVolumeSource : Represents an ISCSI disk. ISCSI volumes can only be mounted as read/write once. ISCSI volumes support ownership management and SELinux relabeling.
...
impl IoK8sKubernetesPkgApiV1IscsiVolumeSource {
  ...
  pub fn new(iqn: String, lun: i32, target_portal: String) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
  ...
  pub fn with_chap_auth_discovery(mut self, chap_auth_discovery: bool) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.chap_auth_discovery = Some(chap_auth_discovery);
    self
  }
  ...
  pub fn with_chap_auth_session(mut self, chap_auth_session: bool) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.chap_auth_session = Some(chap_auth_session);
    self
  }
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_iqn(mut self, iqn: String) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.iqn = iqn;
    self
  }
  ...
  pub fn with_iscsi_interface(mut self, iscsi_interface: String) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.iscsi_interface = Some(iscsi_interface);
    self
  }
  ...
  pub fn with_lun(mut self, lun: i32) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.lun = lun;
    self
  }
  ...
  pub fn with_portals(mut self, portals: Vec<String>) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.portals = Some(portals);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::IoK8sKubernetesPkgApiV1LocalObjectReference) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }
  ...
  pub fn with_target_portal(mut self, target_portal: String) -> IoK8sKubernetesPkgApiV1IscsiVolumeSource {
    self.target_portal = target_portal;
    self
  }
