...
pub struct V1DeploymentSpec {
  ...
  strategy: Option<::models::V1DeploymentStrategy>,
...
impl V1DeploymentSpec {
  ...
  pub fn new(selector: ::models::V1LabelSelector, template: ::models::V1PodTemplateSpec) -> V1DeploymentSpec {
    V1DeploymentSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> V1DeploymentSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_paused(mut self, paused: bool) -> V1DeploymentSpec {
    self.paused = Some(paused);
    self
  }
  ...
  pub fn with_progress_deadline_seconds(mut self, progress_deadline_seconds: i32) -> V1DeploymentSpec {
    self.progress_deadline_seconds = Some(progress_deadline_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1DeploymentSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_revision_history_limit(mut self, revision_history_limit: i32) -> V1DeploymentSpec {
    self.revision_history_limit = Some(revision_history_limit);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::V1LabelSelector) -> V1DeploymentSpec {
    self.selector = selector;
    self
  }
  ...
  pub fn set_strategy(&mut self, strategy: ::models::V1DeploymentStrategy) {
    self.strategy = Some(strategy);
  }

  pub fn with_strategy(mut self, strategy: ::models::V1DeploymentStrategy) -> V1DeploymentSpec {
    self.strategy = Some(strategy);
    self
  }

  pub fn strategy(&self) -> Option<&::models::V1DeploymentStrategy> {
  ...
  pub fn with_template(mut self, template: ::models::V1PodTemplateSpec) -> V1DeploymentSpec {
    self.template = template;
    self
  }
