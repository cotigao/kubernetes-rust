...
impl V1StatusCause {
  ...
  pub fn with_field(mut self, field: String) -> V1StatusCause {
    self.field = Some(field);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> V1StatusCause {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_reason(mut self, reason: String) -> V1StatusCause {
    self.reason = Some(reason);
    self
  }
