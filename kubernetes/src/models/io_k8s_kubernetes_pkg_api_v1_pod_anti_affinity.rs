...
/// IoK8sKubernetesPkgApiV1PodAntiAffinity : Pod anti affinity is a group of inter pod anti affinity scheduling rules.
...
impl IoK8sKubernetesPkgApiV1PodAntiAffinity {
  ...
  pub fn with_preferred_during_scheduling_ignored_during_execution(mut self, preferred_during_scheduling_ignored_during_execution: Vec<::models::IoK8sKubernetesPkgApiV1WeightedPodAffinityTerm>) -> IoK8sKubernetesPkgApiV1PodAntiAffinity {
    self.preferred_during_scheduling_ignored_during_execution = Some(preferred_during_scheduling_ignored_during_execution);
    self
  }
  ...
  pub fn with_required_during_scheduling_ignored_during_execution(mut self, required_during_scheduling_ignored_during_execution: Vec<::models::IoK8sKubernetesPkgApiV1PodAffinityTerm>) -> IoK8sKubernetesPkgApiV1PodAntiAffinity {
    self.required_during_scheduling_ignored_during_execution = Some(required_during_scheduling_ignored_during_execution);
    self
  }
