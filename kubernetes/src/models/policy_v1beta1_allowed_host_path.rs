...
pub struct PolicyV1beta1AllowedHostPath {
...
impl PolicyV1beta1AllowedHostPath {
  /// AllowedHostPath defines the host volume conditions that will be enabled by a policy for pods to use. It requires the path prefix to be defined.
  pub fn new() -> PolicyV1beta1AllowedHostPath {
  ...
  pub fn with_path_prefix(mut self, path_prefix: String) -> PolicyV1beta1AllowedHostPath {
    self.path_prefix = Some(path_prefix);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> PolicyV1beta1AllowedHostPath {
    self.read_only = Some(read_only);
    self
  }
