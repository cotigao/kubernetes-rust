...
impl V1beta1RoleRef {
  ...
  pub fn with_api_group(mut self, api_group: String) -> V1beta1RoleRef {
    self.api_group = api_group;
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1beta1RoleRef {
    self.kind = kind;
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> V1beta1RoleRef {
    self.name = name;
    self
  }
