...
impl IoK8sKubernetesPkgApiV1ContainerStateTerminated {
  ...
  pub fn with_finished_at(mut self, finished_at: String) -> IoK8sKubernetesPkgApiV1ContainerStateTerminated {
    self.finished_at = Some(finished_at);
    self
  }
  ...
  pub fn with_started_at(mut self, started_at: String) -> IoK8sKubernetesPkgApiV1ContainerStateTerminated {
    self.started_at = Some(started_at);
    self
  }
