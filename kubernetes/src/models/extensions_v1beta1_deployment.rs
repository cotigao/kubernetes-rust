...
/// ExtensionsV1beta1Deployment : DEPRECATED - This group version of Deployment is deprecated by apps/v1beta2/Deployment. See the release notes for more information. Deployment enables declarative updates for Pods and ReplicaSets.
...
impl ExtensionsV1beta1Deployment {
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> ExtensionsV1beta1Deployment {
    self.metadata = Some(metadata);
    self
  }
