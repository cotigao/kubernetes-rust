...
impl ExtensionsV1beta1DeploymentCondition {
  ...
  pub fn with_last_transition_time(mut self, last_transition_time: String) -> ExtensionsV1beta1DeploymentCondition {
    self.last_transition_time = Some(last_transition_time);
    self
  }
  ...
  pub fn with_last_update_time(mut self, last_update_time: String) -> ExtensionsV1beta1DeploymentCondition {
    self.last_update_time = Some(last_update_time);
    self
  }
