...
impl IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus {
  ...
  pub fn with_last_scale_time(mut self, last_scale_time: ::models::IoK8sApimachineryPkgApisMetaV1Time) -> IoK8sKubernetesPkgApisAutoscalingV1HorizontalPodAutoscalerStatus {
    self.last_scale_time = Some(last_scale_time);
    self
  }
