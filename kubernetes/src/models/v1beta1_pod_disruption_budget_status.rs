...
pub struct V1beta1PodDisruptionBudgetStatus {
  ...
  disrupted_pods: ::std::collections::HashMap<String, String>,
...
impl V1beta1PodDisruptionBudgetStatus {
  ...
  pub fn new(current_healthy: i32, desired_healthy: i32, disrupted_pods: ::std::collections::HashMap<String, String>, disruptions_allowed: i32, expected_pods: i32) -> V1beta1PodDisruptionBudgetStatus {
  ...
  pub fn with_current_healthy(mut self, current_healthy: i32) -> V1beta1PodDisruptionBudgetStatus {
    self.current_healthy = current_healthy;
    self
  }
  ...
  pub fn with_desired_healthy(mut self, desired_healthy: i32) -> V1beta1PodDisruptionBudgetStatus {
    self.desired_healthy = desired_healthy;
    self
  }
  ...
  pub fn with_disrupted_pods(mut self, disrupted_pods: ::std::collections::HashMap<String, String>) -> V1beta1PodDisruptionBudgetStatus {
    self.disrupted_pods = disrupted_pods;
    self
  }

  pub fn disrupted_pods(&self) -> &::std::collections::HashMap<String, String> {
    &self.disrupted_pods
  }
  ...
  pub fn with_disruptions_allowed(mut self, disruptions_allowed: i32) -> V1beta1PodDisruptionBudgetStatus {
    self.disruptions_allowed = disruptions_allowed;
    self
  }
  ...
  pub fn with_expected_pods(mut self, expected_pods: i32) -> V1beta1PodDisruptionBudgetStatus {
    self.expected_pods = expected_pods;
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> V1beta1PodDisruptionBudgetStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
