...
/// IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus : StatefulSetStatus represents the current state of a StatefulSet.
...
impl IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
  ...
  pub fn new(replicas: i32) -> IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
  ...
  pub fn with_current_replicas(mut self, current_replicas: i32) -> IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
    self.current_replicas = Some(current_replicas);
    self
  }
  ...
  pub fn with_current_revision(mut self, current_revision: String) -> IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
    self.current_revision = Some(current_revision);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
  ...
  pub fn with_ready_replicas(mut self, ready_replicas: i32) -> IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
    self.ready_replicas = Some(ready_replicas);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
    self.replicas = replicas;
    self
  }
  ...
  pub fn with_update_revision(mut self, update_revision: String) -> IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
    self.update_revision = Some(update_revision);
    self
  }
  ...
  pub fn with_updated_replicas(mut self, updated_replicas: i32) -> IoK8sKubernetesPkgApisAppsV1beta1StatefulSetStatus {
    self.updated_replicas = Some(updated_replicas);
    self
  }
