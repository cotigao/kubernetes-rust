...
impl V1OwnerReference {
  ...
  pub fn with_api_version(mut self, api_version: String) -> V1OwnerReference {
    self.api_version = api_version;
    self
  }
  ...
  pub fn with_block_owner_deletion(mut self, block_owner_deletion: bool) -> V1OwnerReference {
    self.block_owner_deletion = Some(block_owner_deletion);
    self
  }
  ...
  pub fn with_controller(mut self, controller: bool) -> V1OwnerReference {
    self.controller = Some(controller);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1OwnerReference {
    self.kind = kind;
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> V1OwnerReference {
    self.name = name;
    self
  }
  ...
  pub fn with_uid(mut self, uid: String) -> V1OwnerReference {
    self.uid = uid;
    self
  }
