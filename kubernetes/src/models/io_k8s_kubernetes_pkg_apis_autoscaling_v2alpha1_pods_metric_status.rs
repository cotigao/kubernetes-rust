...
impl IoK8sKubernetesPkgApisAutoscalingV2alpha1PodsMetricStatus {
  ...
  pub fn new(current_average_value: ::models::IoK8sApimachineryPkgApiResourceQuantity, metric_name: String) -> IoK8sKubernetesPkgApisAutoscalingV2alpha1PodsMetricStatus {
  ...
  pub fn with_current_average_value(mut self, current_average_value: ::models::IoK8sApimachineryPkgApiResourceQuantity) -> IoK8sKubernetesPkgApisAutoscalingV2alpha1PodsMetricStatus {
    self.current_average_value = current_average_value;
    self
  }
