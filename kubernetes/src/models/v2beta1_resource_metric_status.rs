...
impl V2beta1ResourceMetricStatus {
  ...
  pub fn with_current_average_utilization(mut self, current_average_utilization: i32) -> V2beta1ResourceMetricStatus {
    self.current_average_utilization = Some(current_average_utilization);
    self
  }
  ...
  pub fn with_current_average_value(mut self, current_average_value: String) -> V2beta1ResourceMetricStatus {
    self.current_average_value = current_average_value;
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> V2beta1ResourceMetricStatus {
    self.name = name;
    self
  }
