...
impl V1beta1CronJobStatus {
  ...
  pub fn with_active(mut self, active: Vec<::models::V1ObjectReference>) -> V1beta1CronJobStatus {
    self.active = Some(active);
    self
  }
  ...
  pub fn with_last_schedule_time(mut self, last_schedule_time: String) -> V1beta1CronJobStatus {
    self.last_schedule_time = Some(last_schedule_time);
    self
  }
