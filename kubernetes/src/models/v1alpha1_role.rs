...
impl V1alpha1Role {
  ...
  pub fn new(rules: Vec<::models::V1alpha1PolicyRule>) -> V1alpha1Role {
    V1alpha1Role {
      api_version: None,
      kind: None,
      metadata: None,
  ...
  pub fn with_api_version(mut self, api_version: String) -> V1alpha1Role {
    self.api_version = Some(api_version);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1alpha1Role {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> V1alpha1Role {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_rules(mut self, rules: Vec<::models::V1alpha1PolicyRule>) -> V1alpha1Role {
    self.rules = rules;
    self
  }
