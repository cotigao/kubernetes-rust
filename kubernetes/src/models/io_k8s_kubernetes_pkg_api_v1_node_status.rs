...
pub struct IoK8sKubernetesPkgApiV1NodeStatus {
  ...
  allocatable: Option<::std::collections::HashMap<String, ::models::IoK8sApimachineryPkgApiResourceQuantity>>,
...
impl IoK8sKubernetesPkgApiV1NodeStatus {
  ...
  pub fn set_allocatable(&mut self, allocatable: ::std::collections::HashMap<String, ::models::IoK8sApimachineryPkgApiResourceQuantity>) {
    self.allocatable = Some(allocatable);
  }

  pub fn with_allocatable(mut self, allocatable: ::std::collections::HashMap<String, ::models::IoK8sApimachineryPkgApiResourceQuantity>) -> IoK8sKubernetesPkgApiV1NodeStatus {
    self.allocatable = Some(allocatable);
    self
  }

  pub fn allocatable(&self) -> Option<&::std::collections::HashMap<String, ::models::IoK8sApimachineryPkgApiResourceQuantity>> {
  ...
  pub fn with_capacity(mut self, capacity: ::std::collections::HashMap<String, ::models::IoK8sApimachineryPkgApiResourceQuantity>) -> IoK8sKubernetesPkgApiV1NodeStatus {
    self.capacity = Some(capacity);
    self
  }
