...
pub struct V2alpha1CronJobSpec {
  ...
  job_template: ::models::V2alpha1JobTemplateSpec,
...
impl V2alpha1CronJobSpec {
  /// CronJobSpec describes how the job execution will look like and when it will actually run.
  pub fn new(job_template: ::models::V2alpha1JobTemplateSpec, schedule: String) -> V2alpha1CronJobSpec {
    V2alpha1CronJobSpec {
  ...
  pub fn with_concurrency_policy(mut self, concurrency_policy: String) -> V2alpha1CronJobSpec {
    self.concurrency_policy = Some(concurrency_policy);
    self
  }
  ...
  pub fn with_failed_jobs_history_limit(mut self, failed_jobs_history_limit: i32) -> V2alpha1CronJobSpec {
    self.failed_jobs_history_limit = Some(failed_jobs_history_limit);
    self
  }
  ...
  pub fn set_job_template(&mut self, job_template: ::models::V2alpha1JobTemplateSpec) {
    self.job_template = job_template;
  }

  pub fn with_job_template(mut self, job_template: ::models::V2alpha1JobTemplateSpec) -> V2alpha1CronJobSpec {
    self.job_template = job_template;
    self
  }

  pub fn job_template(&self) -> &::models::V2alpha1JobTemplateSpec {
    &self.job_template
  }
  ...
  pub fn with_schedule(mut self, schedule: String) -> V2alpha1CronJobSpec {
    self.schedule = schedule;
    self
  }
  ...
  pub fn with_starting_deadline_seconds(mut self, starting_deadline_seconds: i64) -> V2alpha1CronJobSpec {
    self.starting_deadline_seconds = Some(starting_deadline_seconds);
    self
  }
  ...
  pub fn with_successful_jobs_history_limit(mut self, successful_jobs_history_limit: i32) -> V2alpha1CronJobSpec {
    self.successful_jobs_history_limit = Some(successful_jobs_history_limit);
    self
  }
  ...
  pub fn with_suspend(mut self, suspend: bool) -> V2alpha1CronJobSpec {
    self.suspend = Some(suspend);
    self
  }
