...
impl IoK8sKubernetesPkgApisExtensionsV1beta1IngressBackend {
  ...
  pub fn new(service_name: String, service_port: String) -> IoK8sKubernetesPkgApisExtensionsV1beta1IngressBackend {
  ...
  pub fn with_service_port(mut self, service_port: String) -> IoK8sKubernetesPkgApisExtensionsV1beta1IngressBackend {
    self.service_port = service_port;
    self
  }
