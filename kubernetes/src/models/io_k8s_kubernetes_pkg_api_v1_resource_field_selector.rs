...
pub struct IoK8sKubernetesPkgApiV1ResourceFieldSelector {
  ...
  divisor: Option<::models::IoK8sApimachineryPkgApiResourceQuantity>,
...
impl IoK8sKubernetesPkgApiV1ResourceFieldSelector {
  ...
  pub fn set_divisor(&mut self, divisor: ::models::IoK8sApimachineryPkgApiResourceQuantity) {
    self.divisor = Some(divisor);
  }

  pub fn with_divisor(mut self, divisor: ::models::IoK8sApimachineryPkgApiResourceQuantity) -> IoK8sKubernetesPkgApiV1ResourceFieldSelector {
    self.divisor = Some(divisor);
    self
  }

  pub fn divisor(&self) -> Option<&::models::IoK8sApimachineryPkgApiResourceQuantity> {
    self.divisor.as_ref()
  }
