...
pub struct V1Container {
  ...
  /// List of sources to populate environment variables in the container. The keys defined within a source must be a C_IDENTIFIER. All invalid keys will be reported as an event when the container is starting. When a key exists in multiple sources, the value associated with the last source will take precedence. ::serde_json::Values defined by an Env with a duplicate key will take precedence. Cannot be updated.
  ...
  volume_devices: Option<Vec<::models::V1VolumeDevice>>,
...
impl V1Container {
  ...
  pub fn set_volume_devices(&mut self, volume_devices: Vec<::models::V1VolumeDevice>) {
    self.volume_devices = Some(volume_devices);
  }

  pub fn with_volume_devices(mut self, volume_devices: Vec<::models::V1VolumeDevice>) -> V1Container {
    self.volume_devices = Some(volume_devices);
    self
  }

  pub fn volume_devices(&self) -> Option<&Vec<::models::V1VolumeDevice>> {
