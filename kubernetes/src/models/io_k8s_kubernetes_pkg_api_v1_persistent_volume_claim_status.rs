...
impl IoK8sKubernetesPkgApiV1PersistentVolumeClaimStatus {
  ...
  pub fn with_capacity(mut self, capacity: ::std::collections::HashMap<String, ::models::IoK8sApimachineryPkgApiResourceQuantity>) -> IoK8sKubernetesPkgApiV1PersistentVolumeClaimStatus {
    self.capacity = Some(capacity);
    self
  }
