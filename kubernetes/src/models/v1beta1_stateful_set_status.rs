...
pub struct V1beta1StatefulSetStatus {
  ...
  conditions: Option<Vec<::models::V1beta1StatefulSetCondition>>,
...
impl V1beta1StatefulSetStatus {
  ...
  pub fn with_collision_count(mut self, collision_count: i32) -> V1beta1StatefulSetStatus {
    self.collision_count = Some(collision_count);
    self
  }
  ...
  pub fn set_conditions(&mut self, conditions: Vec<::models::V1beta1StatefulSetCondition>) {
    self.conditions = Some(conditions);
  }

  pub fn with_conditions(mut self, conditions: Vec<::models::V1beta1StatefulSetCondition>) -> V1beta1StatefulSetStatus {
    self.conditions = Some(conditions);
    self
  }

  pub fn conditions(&self) -> Option<&Vec<::models::V1beta1StatefulSetCondition>> {
