...
pub struct IoK8sKubernetesPkgApisAutoscalingV2alpha1ResourceMetricSource {
  ...
  target_average_value: Option<::models::IoK8sApimachineryPkgApiResourceQuantity>
}
...
impl IoK8sKubernetesPkgApisAutoscalingV2alpha1ResourceMetricSource {
  ...
  pub fn with_target_average_value(mut self, target_average_value: ::models::IoK8sApimachineryPkgApiResourceQuantity) -> IoK8sKubernetesPkgApisAutoscalingV2alpha1ResourceMetricSource {
    self.target_average_value = Some(target_average_value);
    self
  }

  pub fn target_average_value(&self) -> Option<&::models::IoK8sApimachineryPkgApiResourceQuantity> {
