...
pub struct IoK8sKubernetesPkgApiV1Taint {
  ...
  time_added: Option<::models::IoK8sApimachineryPkgApisMetaV1Time>,
...
impl IoK8sKubernetesPkgApiV1Taint {
  ...
  pub fn set_time_added(&mut self, time_added: ::models::IoK8sApimachineryPkgApisMetaV1Time) {
    self.time_added = Some(time_added);
  }

  pub fn with_time_added(mut self, time_added: ::models::IoK8sApimachineryPkgApisMetaV1Time) -> IoK8sKubernetesPkgApiV1Taint {
    self.time_added = Some(time_added);
    self
  }

  pub fn time_added(&self) -> Option<&::models::IoK8sApimachineryPkgApisMetaV1Time> {
