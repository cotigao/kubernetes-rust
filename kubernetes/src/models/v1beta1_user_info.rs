...
impl V1beta1UserInfo {
  ...
  pub fn with_extra(mut self, extra: ::std::collections::HashMap<String, Vec<String>>) -> V1beta1UserInfo {
    self.extra = Some(extra);
    self
  }
  ...
  pub fn with_groups(mut self, groups: Vec<String>) -> V1beta1UserInfo {
    self.groups = Some(groups);
    self
  }
  ...
  pub fn with_uid(mut self, uid: String) -> V1beta1UserInfo {
    self.uid = Some(uid);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> V1beta1UserInfo {
    self.username = Some(username);
    self
  }
