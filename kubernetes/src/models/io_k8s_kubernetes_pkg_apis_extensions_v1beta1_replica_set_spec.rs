...
/// IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec : ReplicaSetSpec is the specification of a ReplicaSet.
...
impl IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::IoK8sKubernetesPkgApiV1PodTemplateSpec) -> IoK8sKubernetesPkgApisExtensionsV1beta1ReplicaSetSpec {
    self.template = Some(template);
    self
  }
