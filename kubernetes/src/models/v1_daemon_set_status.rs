...
pub struct V1DaemonSetStatus {
  ...
  conditions: Option<Vec<::models::V1DaemonSetCondition>>,
...
impl V1DaemonSetStatus {
  ...
  pub fn with_collision_count(mut self, collision_count: i32) -> V1DaemonSetStatus {
    self.collision_count = Some(collision_count);
    self
  }
  ...
  pub fn set_conditions(&mut self, conditions: Vec<::models::V1DaemonSetCondition>) {
    self.conditions = Some(conditions);
  }

  pub fn with_conditions(mut self, conditions: Vec<::models::V1DaemonSetCondition>) -> V1DaemonSetStatus {
    self.conditions = Some(conditions);
    self
  }

  pub fn conditions(&self) -> Option<&Vec<::models::V1DaemonSetCondition>> {
  ...
  pub fn with_current_number_scheduled(mut self, current_number_scheduled: i32) -> V1DaemonSetStatus {
    self.current_number_scheduled = current_number_scheduled;
    self
  }
  ...
  pub fn with_desired_number_scheduled(mut self, desired_number_scheduled: i32) -> V1DaemonSetStatus {
    self.desired_number_scheduled = desired_number_scheduled;
    self
  }
  ...
  pub fn with_number_available(mut self, number_available: i32) -> V1DaemonSetStatus {
    self.number_available = Some(number_available);
    self
  }
  ...
  pub fn with_number_misscheduled(mut self, number_misscheduled: i32) -> V1DaemonSetStatus {
    self.number_misscheduled = number_misscheduled;
    self
  }
  ...
  pub fn with_number_ready(mut self, number_ready: i32) -> V1DaemonSetStatus {
    self.number_ready = number_ready;
    self
  }
  ...
  pub fn with_number_unavailable(mut self, number_unavailable: i32) -> V1DaemonSetStatus {
    self.number_unavailable = Some(number_unavailable);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> V1DaemonSetStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
  ...
  pub fn with_updated_number_scheduled(mut self, updated_number_scheduled: i32) -> V1DaemonSetStatus {
    self.updated_number_scheduled = Some(updated_number_scheduled);
    self
  }
