...
/// V1beta1SeLinuxStrategyOptions : SELinux  Strategy Options defines the strategy type and any options used to create the strategy.
...
impl V1beta1SeLinuxStrategyOptions {
  ...
  pub fn with_rule(mut self, rule: String) -> V1beta1SeLinuxStrategyOptions {
    self.rule = rule;
    self
  }
  ...
  pub fn with_se_linux_options(mut self, se_linux_options: ::models::V1SeLinuxOptions) -> V1beta1SeLinuxStrategyOptions {
    self.se_linux_options = Some(se_linux_options);
    self
  }
