...
impl V1ClusterRoleBinding {
  ...
  pub fn new(role_ref: ::models::V1RoleRef) -> V1ClusterRoleBinding {
  ...
  pub fn with_api_version(mut self, api_version: String) -> V1ClusterRoleBinding {
    self.api_version = Some(api_version);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1ClusterRoleBinding {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: ::models::V1ObjectMeta) -> V1ClusterRoleBinding {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_role_ref(mut self, role_ref: ::models::V1RoleRef) -> V1ClusterRoleBinding {
    self.role_ref = role_ref;
    self
  }
  ...
  pub fn with_subjects(mut self, subjects: Vec<::models::V1Subject>) -> V1ClusterRoleBinding {
    self.subjects = Some(subjects);
    self
  }
