...
pub struct V1beta1StatefulSetSpec {
  ...
  update_strategy: Option<::models::V1beta1StatefulSetUpdateStrategy>,
...
impl V1beta1StatefulSetSpec {
  /// A StatefulSetSpec is the specification of a StatefulSet.
  pub fn new(service_name: String, template: ::models::V1PodTemplateSpec) -> V1beta1StatefulSetSpec {
  ...
  pub fn with_pod_management_policy(mut self, pod_management_policy: String) -> V1beta1StatefulSetSpec {
    self.pod_management_policy = Some(pod_management_policy);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1beta1StatefulSetSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_revision_history_limit(mut self, revision_history_limit: i32) -> V1beta1StatefulSetSpec {
    self.revision_history_limit = Some(revision_history_limit);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::V1LabelSelector) -> V1beta1StatefulSetSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_service_name(mut self, service_name: String) -> V1beta1StatefulSetSpec {
    self.service_name = service_name;
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::V1PodTemplateSpec) -> V1beta1StatefulSetSpec {
    self.template = template;
    self
  }
  ...
  pub fn set_update_strategy(&mut self, update_strategy: ::models::V1beta1StatefulSetUpdateStrategy) {
    self.update_strategy = Some(update_strategy);
  }

  pub fn with_update_strategy(mut self, update_strategy: ::models::V1beta1StatefulSetUpdateStrategy) -> V1beta1StatefulSetSpec {
    self.update_strategy = Some(update_strategy);
    self
  }

  pub fn update_strategy(&self) -> Option<&::models::V1beta1StatefulSetUpdateStrategy> {
  ...
  pub fn with_volume_claim_templates(mut self, volume_claim_templates: Vec<::models::V1PersistentVolumeClaim>) -> V1beta1StatefulSetSpec {
    self.volume_claim_templates = Some(volume_claim_templates);
    self
  }
