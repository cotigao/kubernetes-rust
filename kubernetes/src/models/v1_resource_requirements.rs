...
impl V1ResourceRequirements {
  ...
  pub fn with_limits(mut self, limits: ::std::collections::HashMap<String, String>) -> V1ResourceRequirements {
    self.limits = Some(limits);
    self
  }
  ...
  pub fn with_requests(mut self, requests: ::std::collections::HashMap<String, String>) -> V1ResourceRequirements {
    self.requests = Some(requests);
    self
  }
