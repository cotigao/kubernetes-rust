...
pub trait AuthorizationV1beta1Api {
    fn create_namespaced_local_subject_access_review(&self, namespace: &str, body: ::models::V1beta1LocalSubjectAccessReview, dry_run: &str, include_uninitialized: bool, pretty: &str) -> Box<Future<Item = ::models::V1beta1LocalSubjectAccessReview, Error = Error>>;
    fn create_self_subject_access_review(&self, body: ::models::V1beta1SelfSubjectAccessReview, dry_run: &str, include_uninitialized: bool, pretty: &str) -> Box<Future<Item = ::models::V1beta1SelfSubjectAccessReview, Error = Error>>;
    fn create_self_subject_rules_review(&self, body: ::models::V1beta1SelfSubjectRulesReview, dry_run: &str, include_uninitialized: bool, pretty: &str) -> Box<Future<Item = ::models::V1beta1SelfSubjectRulesReview, Error = Error>>;
    fn create_subject_access_review(&self, body: ::models::V1beta1SubjectAccessReview, dry_run: &str, include_uninitialized: bool, pretty: &str) -> Box<Future<Item = ::models::V1beta1SubjectAccessReview, Error = Error>>;
...
impl<C: hyper::client::Connect>AuthorizationV1beta1Api for AuthorizationV1beta1ApiClient<C> {
    ...
    fn create_self_subject_rules_review(&self, body: ::models::V1beta1SelfSubjectRulesReview, dry_run: &str, include_uninitialized: bool, pretty: &str) -> Box<Future<Item = ::models::V1beta1SelfSubjectRulesReview, Error = Error>> {
        ...
        let query = ::url::form_urlencoded::Serializer::new("?".to_string())
            ...
            .append_pair("pretty", &pretty.to_string())
            .finish();
        let uri_str = format!("{}/apis/authorization.k8s.io/v1beta1/selfsubjectrulesreviews{}", configuration.base_path, query);
        ...
        Box::new(
            ...
            .map_err(|e| Error::from(e))
            .and_then(|body| {
                let parsed: Result<::models::V1beta1SelfSubjectRulesReview, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            }).map_err(|e| Error::from(e))
        )
    }
