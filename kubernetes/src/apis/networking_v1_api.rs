...
pub trait NetworkingV1Api {
    fn create_namespaced_network_policy(&self, namespace: &str, body: ::models::V1NetworkPolicy, include_uninitialized: bool, pretty: &str, dry_run: &str) -> Box<Future<Item = ::models::V1NetworkPolicy, Error = Error>>;
    ...
    fn list_namespaced_network_policy(&self, namespace: &str, include_uninitialized: bool, pretty: &str, _continue: &str, field_selector: &str, label_selector: &str, limit: i32, resource_version: &str, timeout_seconds: i32, watch: bool) -> Box<Future<Item = ::models::V1NetworkPolicyList, Error = Error>>;
    fn list_network_policy_for_all_namespaces(&self, _continue: &str, field_selector: &str, include_uninitialized: bool, label_selector: &str, limit: i32, pretty: &str, resource_version: &str, timeout_seconds: i32, watch: bool) -> Box<Future<Item = ::models::V1NetworkPolicyList, Error = Error>>;
    fn patch_namespaced_network_policy(&self, name: &str, namespace: &str, body: ::serde_json::Value, pretty: &str, dry_run: &str) -> Box<Future<Item = ::models::V1NetworkPolicy, Error = Error>>;
    ...
    fn replace_namespaced_network_policy(&self, name: &str, namespace: &str, body: ::models::V1NetworkPolicy, pretty: &str, dry_run: &str) -> Box<Future<Item = ::models::V1NetworkPolicy, Error = Error>>;
}
