...
pub trait CoreApi {
    fn get_core_api_versions(&self, ) -> Box<Future<Item = ::models::IoK8sApimachineryPkgApisMetaV1ApiVersions, Error = Error<serde_json::Value>>>;
}


impl<C: hyper::client::Connect>CoreApi for CoreApiClient<C> {
    fn get_core_api_versions(&self, ) -> Box<Future<Item = ::models::IoK8sApimachineryPkgApisMetaV1ApiVersions, Error = Error<serde_json::Value>>> {
        __internal_request::Request::new(hyper::Method::Get, "/api/".to_string())
