...
pub trait CoreApi {
    fn get_core_api_versions(&self, ) -> Box<Future<Item = ::models::IoK8sApimachineryPkgApisMetaV1ApiVersions, Error = Error>>;
}
...
impl<C: hyper::client::Connect>CoreApi for CoreApiClient<C> {
    fn get_core_api_versions(&self, ) -> Box<Future<Item = ::models::IoK8sApimachineryPkgApisMetaV1ApiVersions, Error = Error>> {
        ...
        Box::new(
            ...
            .and_then(|body| {
                let parsed: Result<::models::IoK8sApimachineryPkgApisMetaV1ApiVersions, _> = serde_json::from_slice(&body);
