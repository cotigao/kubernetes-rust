...
pub trait AuthorizationV1Api {
    fn create_namespaced_local_subject_access_review(&self, namespace: &str, body: ::models::V1LocalSubjectAccessReview, pretty: &str) -> Box<Future<Item = ::models::V1LocalSubjectAccessReview, Error = Error>>;
    fn create_self_subject_access_review(&self, body: ::models::V1SelfSubjectAccessReview, pretty: &str) -> Box<Future<Item = ::models::V1SelfSubjectAccessReview, Error = Error>>;
    fn create_subject_access_review(&self, body: ::models::V1SubjectAccessReview, pretty: &str) -> Box<Future<Item = ::models::V1SubjectAccessReview, Error = Error>>;
