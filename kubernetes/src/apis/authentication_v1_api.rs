...
pub trait AuthenticationV1Api {
    fn create_token_review(&self, body: ::models::V1TokenReview, dry_run: &str, include_uninitialized: bool, pretty: &str) -> Box<Future<Item = ::models::V1TokenReview, Error = Error>>;
...
impl<C: hyper::client::Connect>AuthenticationV1Api for AuthenticationV1ApiClient<C> {
    fn create_token_review(&self, body: ::models::V1TokenReview, dry_run: &str, include_uninitialized: bool, pretty: &str) -> Box<Future<Item = ::models::V1TokenReview, Error = Error>> {
        ...
        Box::new(
            ...
            .and_then(|body| {
                let parsed: Result<::models::V1TokenReview, _> = serde_json::from_slice(&body);
