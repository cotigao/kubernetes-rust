...
pub trait AuthenticationV1beta1Api {
    fn create_token_review(&self, body: ::models::V1beta1TokenReview, dry_run: &str, include_uninitialized: bool, pretty: &str) -> Box<Future<Item = ::models::V1beta1TokenReview, Error = Error>>;
