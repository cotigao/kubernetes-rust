...
pub trait StorageV1Api {
    fn create_storage_class(&self, body: ::models::V1StorageClass, include_uninitialized: bool, pretty: &str, dry_run: &str) -> Box<Future<Item = ::models::V1StorageClass, Error = Error>>;
    ...
    fn list_storage_class(&self, include_uninitialized: bool, pretty: &str, _continue: &str, field_selector: &str, label_selector: &str, limit: i32, resource_version: &str, timeout_seconds: i32, watch: bool) -> Box<Future<Item = ::models::V1StorageClassList, Error = Error>>;
    fn patch_storage_class(&self, name: &str, body: ::serde_json::Value, pretty: &str, dry_run: &str) -> Box<Future<Item = ::models::V1StorageClass, Error = Error>>;
    fn read_storage_class(&self, name: &str, pretty: &str, exact: bool, export: bool) -> Box<Future<Item = ::models::V1StorageClass, Error = Error>>;
    fn replace_storage_class(&self, name: &str, body: ::models::V1StorageClass, pretty: &str, dry_run: &str) -> Box<Future<Item = ::models::V1StorageClass, Error = Error>>;
}
