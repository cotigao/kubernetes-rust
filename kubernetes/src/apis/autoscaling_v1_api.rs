...
pub trait AutoscalingV1Api {
    fn create_namespaced_horizontal_pod_autoscaler(&self, namespace: &str, body: ::models::V1HorizontalPodAutoscaler, pretty: &str) -> Box<Future<Item = ::models::V1HorizontalPodAutoscaler, Error = Error>>;
    ...
    fn list_horizontal_pod_autoscaler_for_all_namespaces(&self, field_selector: &str, include_uninitialized: bool, label_selector: &str, pretty: &str, resource_version: &str, timeout_seconds: i32, watch: bool) -> Box<Future<Item = ::models::V1HorizontalPodAutoscalerList, Error = Error>>;
    fn list_namespaced_horizontal_pod_autoscaler(&self, namespace: &str, pretty: &str, field_selector: &str, include_uninitialized: bool, label_selector: &str, resource_version: &str, timeout_seconds: i32, watch: bool) -> Box<Future<Item = ::models::V1HorizontalPodAutoscalerList, Error = Error>>;
    fn patch_namespaced_horizontal_pod_autoscaler(&self, name: &str, namespace: &str, body: ::serde_json::Value, pretty: &str) -> Box<Future<Item = ::models::V1HorizontalPodAutoscaler, Error = Error>>;
    fn patch_namespaced_horizontal_pod_autoscaler_status(&self, name: &str, namespace: &str, body: ::serde_json::Value, pretty: &str) -> Box<Future<Item = ::models::V1HorizontalPodAutoscaler, Error = Error>>;
    ...
    fn replace_namespaced_horizontal_pod_autoscaler(&self, name: &str, namespace: &str, body: ::models::V1HorizontalPodAutoscaler, pretty: &str) -> Box<Future<Item = ::models::V1HorizontalPodAutoscaler, Error = Error>>;
    fn replace_namespaced_horizontal_pod_autoscaler_status(&self, name: &str, namespace: &str, body: ::models::V1HorizontalPodAutoscaler, pretty: &str) -> Box<Future<Item = ::models::V1HorizontalPodAutoscaler, Error = Error>>;
}
