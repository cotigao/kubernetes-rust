...
pub trait BatchV1Api {
    fn create_namespaced_job(&self, namespace: &str, body: ::models::V1Job, pretty: &str) -> Box<Future<Item = ::models::V1Job, Error = Error>>;
    fn delete_collection_namespaced_job(&self, namespace: &str, pretty: &str, field_selector: &str, include_uninitialized: bool, label_selector: &str, resource_version: &str, timeout_seconds: i32, watch: bool) -> Box<Future<Item = ::models::V1Status, Error = Error>>;
    fn delete_namespaced_job(&self, name: &str, namespace: &str, body: ::models::V1DeleteOptions, pretty: &str, grace_period_seconds: i32, orphan_dependents: bool, propagation_policy: &str) -> Box<Future<Item = ::models::V1Status, Error = Error>>;
    fn get_api_resources(&self, ) -> Box<Future<Item = ::models::V1ApiResourceList, Error = Error>>;
    fn list_job_for_all_namespaces(&self, field_selector: &str, include_uninitialized: bool, label_selector: &str, pretty: &str, resource_version: &str, timeout_seconds: i32, watch: bool) -> Box<Future<Item = ::models::V1JobList, Error = Error>>;
    fn list_namespaced_job(&self, namespace: &str, pretty: &str, field_selector: &str, include_uninitialized: bool, label_selector: &str, resource_version: &str, timeout_seconds: i32, watch: bool) -> Box<Future<Item = ::models::V1JobList, Error = Error>>;
    fn patch_namespaced_job(&self, name: &str, namespace: &str, body: ::serde_json::Value, pretty: &str) -> Box<Future<Item = ::models::V1Job, Error = Error>>;
    fn patch_namespaced_job_status(&self, name: &str, namespace: &str, body: ::serde_json::Value, pretty: &str) -> Box<Future<Item = ::models::V1Job, Error = Error>>;
    ...
    fn replace_namespaced_job(&self, name: &str, namespace: &str, body: ::models::V1Job, pretty: &str) -> Box<Future<Item = ::models::V1Job, Error = Error>>;
    fn replace_namespaced_job_status(&self, name: &str, namespace: &str, body: ::models::V1Job, pretty: &str) -> Box<Future<Item = ::models::V1Job, Error = Error>>;
}
