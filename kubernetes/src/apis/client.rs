...
pub struct APIClient<C: hyper::client::Connect> {
  ...
  custom_objects_api: Box<::apis::CustomObjectsApi>,
...
impl<C: hyper::client::Connect> APIClient<C> {
  pub fn new(configuration: Configuration<C>) -> APIClient<C> {
    ...
    APIClient {
      ...
      custom_objects_api: Box::new(::apis::CustomObjectsApiClient::new(rc.clone())),
  ...
  pub fn custom_objects_api(&self) -> &::apis::CustomObjectsApi{
