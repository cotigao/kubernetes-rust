...
> ::models::AppsV1beta1Scale patch_namespaced_stateful_set_scale(ctx, name, namespace, body, optional)
...
> ::models::AppsV1beta1Scale read_namespaced_stateful_set_scale(ctx, name, namespace, optional)
...
> ::models::AppsV1beta1Scale replace_namespaced_stateful_set_scale(ctx, name, namespace, body, optional)
