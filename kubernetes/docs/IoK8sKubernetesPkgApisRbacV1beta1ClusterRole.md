...
**rules** | [**Vec<::models::IoK8sKubernetesPkgApisRbacV1beta1PolicyRule>**](io.k8s.kubernetes.pkg.apis.rbac.v1beta1.PolicyRule.md) | Rules holds all the PolicyRules for this ClusterRole | [default to null]
