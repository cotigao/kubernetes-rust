...
**conditions** | [**Vec<::models::V1beta2DeploymentCondition>**](v1beta2.DeploymentCondition.md) | Represents the latest available observations of a deployment&#39;s current state. | [optional] [default to null]
