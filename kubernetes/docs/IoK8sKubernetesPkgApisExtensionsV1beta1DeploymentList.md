...
**items** | [**Vec<::models::IoK8sKubernetesPkgApisExtensionsV1beta1Deployment>**](io.k8s.kubernetes.pkg.apis.extensions.v1beta1.Deployment.md) | Items is the list of Deployments. | 
