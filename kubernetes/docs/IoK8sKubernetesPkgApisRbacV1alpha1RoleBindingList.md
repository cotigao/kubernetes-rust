...
**items** | [**Vec<::models::IoK8sKubernetesPkgApisRbacV1alpha1RoleBinding>**](io.k8s.kubernetes.pkg.apis.rbac.v1alpha1.RoleBinding.md) | Items is a list of RoleBindings | 
