...
> ::models::V1alpha1PriorityClass create_priority_class(ctx, body, optional)
...
[**::models::V1alpha1PriorityClass**](v1alpha1.PriorityClass.md)
...
> ::models::V1Status delete_collection_priority_class(ctx, optional)
...
> ::models::V1Status delete_priority_class(ctx, name, body, optional)
...
# **list_priority_class**
> ::models::V1alpha1PriorityClassList list_priority_class(ctx, optional)
...
[**::models::V1alpha1PriorityClassList**](v1alpha1.PriorityClassList.md)
...
> ::models::V1alpha1PriorityClass patch_priority_class(ctx, name, body, optional)
...
# **read_priority_class**
> ::models::V1alpha1PriorityClass read_priority_class(ctx, name, optional)
...
> ::models::V1alpha1PriorityClass replace_priority_class(ctx, name, body, optional)
