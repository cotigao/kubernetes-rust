...
**conditions** | [**Vec<::models::IoK8sKubernetesPkgApiV1ComponentCondition>**](io.k8s.kubernetes.pkg.api.v1.ComponentCondition.md) | List of component conditions observed | [optional] [default to null]
