...
**data** | [***::models::IoK8sApimachineryPkgRuntimeRawExtension**](io.k8s.apimachinery.pkg.runtime.RawExtension.md) | Data is the serialized representation of the state. | [optional] [default to null]
