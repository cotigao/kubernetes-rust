...
> ::models::IoK8sKubernetesPkgApisStorageV1StorageClass create_storage_v1_storage_class(ctx, body, optional)
...
> ::models::IoK8sApimachineryPkgApisMetaV1Status delete_storage_v1_storage_class(ctx, name, body, optional)
...
> ::models::IoK8sKubernetesPkgApisStorageV1StorageClass patch_storage_v1_storage_class(ctx, name, body, optional)
...
> ::models::IoK8sKubernetesPkgApisStorageV1StorageClass replace_storage_v1_storage_class(ctx, name, body, optional)
