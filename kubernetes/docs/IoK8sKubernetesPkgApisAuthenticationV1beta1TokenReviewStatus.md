...
**user** | [***::models::IoK8sKubernetesPkgApisAuthenticationV1beta1UserInfo**](io.k8s.kubernetes.pkg.apis.authentication.v1beta1.UserInfo.md) | User is the UserInfo associated with the provided token. | [optional] [default to null]
