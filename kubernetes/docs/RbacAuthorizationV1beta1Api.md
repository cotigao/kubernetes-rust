...
# **create_cluster_role**
> ::models::V1beta1ClusterRole create_cluster_role(ctx, body, optional)
...
[**::models::V1beta1ClusterRole**](v1beta1.ClusterRole.md)
...
> ::models::V1beta1ClusterRoleBinding create_cluster_role_binding(ctx, body, optional)
...
[**::models::V1beta1ClusterRoleBinding**](v1beta1.ClusterRoleBinding.md)
...
> ::models::V1beta1Role create_namespaced_role(ctx, namespace, body, optional)
...
[**::models::V1beta1Role**](v1beta1.Role.md)
...
> ::models::V1beta1RoleBinding create_namespaced_role_binding(ctx, namespace, body, optional)
...
[**::models::V1beta1RoleBinding**](v1beta1.RoleBinding.md)
...
# **list_cluster_role**
> ::models::V1beta1ClusterRoleList list_cluster_role(ctx, optional)
...
[**::models::V1beta1ClusterRoleList**](v1beta1.ClusterRoleList.md)
...
> ::models::V1beta1ClusterRoleBindingList list_cluster_role_binding(ctx, optional)
...
[**::models::V1beta1ClusterRoleBindingList**](v1beta1.ClusterRoleBindingList.md)
...
> ::models::V1beta1RoleList list_namespaced_role(ctx, namespace, optional)
...
[**::models::V1beta1RoleList**](v1beta1.RoleList.md)
...
> ::models::V1beta1RoleBindingList list_namespaced_role_binding(ctx, namespace, optional)
...
[**::models::V1beta1RoleBindingList**](v1beta1.RoleBindingList.md)
...
> ::models::V1beta1RoleBindingList list_role_binding_for_all_namespaces(ctx, optional)
...
> ::models::V1beta1RoleList list_role_for_all_namespaces(ctx, optional)
...
# **patch_cluster_role**
> ::models::V1beta1ClusterRole patch_cluster_role(ctx, name, body, optional)
...
> ::models::V1beta1ClusterRoleBinding patch_cluster_role_binding(ctx, name, body, optional)
...
> ::models::V1beta1Role patch_namespaced_role(ctx, name, namespace, body, optional)
...
> ::models::V1beta1RoleBinding patch_namespaced_role_binding(ctx, name, namespace, body, optional)
...
# **read_cluster_role**
> ::models::V1beta1ClusterRole read_cluster_role(ctx, name, optional)
...
> ::models::V1beta1ClusterRoleBinding read_cluster_role_binding(ctx, name, optional)
...
> ::models::V1beta1Role read_namespaced_role(ctx, name, namespace, optional)
...
> ::models::V1beta1RoleBinding read_namespaced_role_binding(ctx, name, namespace, optional)
...
> ::models::V1beta1ClusterRole replace_cluster_role(ctx, name, body, optional)
...
> ::models::V1beta1ClusterRoleBinding replace_cluster_role_binding(ctx, name, body, optional)
...
> ::models::V1beta1Role replace_namespaced_role(ctx, name, namespace, body, optional)
...
> ::models::V1beta1RoleBinding replace_namespaced_role_binding(ctx, name, namespace, body, optional)
