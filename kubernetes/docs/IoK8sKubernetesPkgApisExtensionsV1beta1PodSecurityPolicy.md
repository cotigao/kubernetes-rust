...
**spec** | [***::models::IoK8sKubernetesPkgApisExtensionsV1beta1PodSecurityPolicySpec**](io.k8s.kubernetes.pkg.apis.extensions.v1beta1.PodSecurityPolicySpec.md) | spec defines the policy enforced. | [optional] [default to null]
