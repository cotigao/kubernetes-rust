...
> ::models::IoK8sKubernetesPkgApisBatchV1Job create_batch_v1_namespaced_job(ctx, namespace, body, optional)
...
> ::models::IoK8sApimachineryPkgApisMetaV1Status delete_batch_v1_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::IoK8sKubernetesPkgApisBatchV1Job patch_batch_v1_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::IoK8sKubernetesPkgApisBatchV1Job patch_batch_v1_namespaced_job_status(ctx, name, namespace, body, optional)
...
> ::models::IoK8sKubernetesPkgApisBatchV1Job replace_batch_v1_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::IoK8sKubernetesPkgApisBatchV1Job replace_batch_v1_namespaced_job_status(ctx, name, namespace, body, optional)
