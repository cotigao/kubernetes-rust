...
**secret_ref** | [***::models::V1ObjectReference**](v1.ObjectReference.md) | SecretRef specifies the secret to use for obtaining the StorageOS API credentials.  If not specified, default values will be attempted. | [optional] [default to null]
