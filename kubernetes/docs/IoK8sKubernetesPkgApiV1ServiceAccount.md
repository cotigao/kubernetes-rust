...
**secrets** | [**Vec<::models::IoK8sKubernetesPkgApiV1ObjectReference>**](io.k8s.kubernetes.pkg.api.v1.ObjectReference.md) | Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount. More info: https://kubernetes.io/docs/concepts/configuration/secret | [optional] [default to null]
