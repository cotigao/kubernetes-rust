...
# **create_cluster_role**
> ::models::V1ClusterRole create_cluster_role(ctx, body, optional)
...
[**::models::V1ClusterRole**](v1.ClusterRole.md)
...
> ::models::V1ClusterRoleBinding create_cluster_role_binding(ctx, body, optional)
...
[**::models::V1ClusterRoleBinding**](v1.ClusterRoleBinding.md)
...
> ::models::V1Role create_namespaced_role(ctx, namespace, body, optional)
...
> ::models::V1RoleBinding create_namespaced_role_binding(ctx, namespace, body, optional)
...
[**::models::V1RoleBinding**](v1.RoleBinding.md)
...
# **list_cluster_role**
> ::models::V1ClusterRoleList list_cluster_role(ctx, optional)
...
[**::models::V1ClusterRoleList**](v1.ClusterRoleList.md)
...
> ::models::V1ClusterRoleBindingList list_cluster_role_binding(ctx, optional)
...
[**::models::V1ClusterRoleBindingList**](v1.ClusterRoleBindingList.md)
...
> ::models::V1RoleList list_namespaced_role(ctx, namespace, optional)
...
[**::models::V1RoleList**](v1.RoleList.md)
...
> ::models::V1RoleBindingList list_namespaced_role_binding(ctx, namespace, optional)
...
[**::models::V1RoleBindingList**](v1.RoleBindingList.md)
...
> ::models::V1RoleBindingList list_role_binding_for_all_namespaces(ctx, optional)
...
> ::models::V1RoleList list_role_for_all_namespaces(ctx, optional)
...
# **patch_cluster_role**
> ::models::V1ClusterRole patch_cluster_role(ctx, name, body, optional)
...
> ::models::V1ClusterRoleBinding patch_cluster_role_binding(ctx, name, body, optional)
...
> ::models::V1Role patch_namespaced_role(ctx, name, namespace, body, optional)
...
> ::models::V1RoleBinding patch_namespaced_role_binding(ctx, name, namespace, body, optional)
...
# **read_cluster_role**
> ::models::V1ClusterRole read_cluster_role(ctx, name, optional)
...
> ::models::V1ClusterRoleBinding read_cluster_role_binding(ctx, name, optional)
...
> ::models::V1Role read_namespaced_role(ctx, name, namespace, optional)
...
> ::models::V1RoleBinding read_namespaced_role_binding(ctx, name, namespace, optional)
...
> ::models::V1ClusterRole replace_cluster_role(ctx, name, body, optional)
...
> ::models::V1ClusterRoleBinding replace_cluster_role_binding(ctx, name, body, optional)
...
> ::models::V1Role replace_namespaced_role(ctx, name, namespace, body, optional)
...
> ::models::V1RoleBinding replace_namespaced_role_binding(ctx, name, namespace, body, optional)
