...
**rollback_to** | [***::models::IoK8sKubernetesPkgApisAppsV1beta1RollbackConfig**](io.k8s.kubernetes.pkg.apis.apps.v1beta1.RollbackConfig.md) | The config of this deployment rollback. | [default to null]
