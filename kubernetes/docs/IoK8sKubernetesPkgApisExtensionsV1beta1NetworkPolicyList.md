...
**items** | [**Vec<::models::IoK8sKubernetesPkgApisExtensionsV1beta1NetworkPolicy>**](io.k8s.kubernetes.pkg.apis.extensions.v1beta1.NetworkPolicy.md) | Items is a list of schema objects. | 
