...
> ::models::V1beta1CertificateSigningRequest patch_certificate_signing_request_status(ctx, name, body, optional)
...
> ::models::V1beta1CertificateSigningRequest read_certificate_signing_request_status(ctx, name, optional)
