...
> ::models::V1HorizontalPodAutoscaler create_namespaced_horizontal_pod_autoscaler(ctx, namespace, body, optional)
...
[**::models::V1HorizontalPodAutoscaler**](v1.HorizontalPodAutoscaler.md)
...
> ::models::V1HorizontalPodAutoscalerList list_horizontal_pod_autoscaler_for_all_namespaces(ctx, optional)
...
[**::models::V1HorizontalPodAutoscalerList**](v1.HorizontalPodAutoscalerList.md)
...
> ::models::V1HorizontalPodAutoscalerList list_namespaced_horizontal_pod_autoscaler(ctx, namespace, optional)
...
> ::models::V1HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler(ctx, name, namespace, body, optional)
...
> ::models::V1HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler_status(ctx, name, namespace, body, optional)
...
> ::models::V1HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler(ctx, name, namespace, optional)
...
> ::models::V1HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler_status(ctx, name, namespace, optional)
...
> ::models::V1HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler(ctx, name, namespace, body, optional)
...
> ::models::V1HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler_status(ctx, name, namespace, body, optional)
