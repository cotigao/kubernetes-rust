...
**role_ref** | [***::models::IoK8sKubernetesPkgApisRbacV1beta1RoleRef**](io.k8s.kubernetes.pkg.apis.rbac.v1beta1.RoleRef.md) | RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error. | [default to null]
