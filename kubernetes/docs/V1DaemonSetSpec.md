...
**update_strategy** | [***::models::V1DaemonSetUpdateStrategy**](v1.DaemonSetUpdateStrategy.md) | An update strategy to replace existing DaemonSet pods with new pods. | [optional] [default to null]
